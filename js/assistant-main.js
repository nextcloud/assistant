...
/* harmony export */   addAssistantMenuEntry: () => (/* binding */ addAssistantMenuEntry),
/* harmony export */   cancelCurrentSyncTask: () => (/* binding */ cancelCurrentSyncTask),
/* harmony export */   handleNotification: () => (/* binding */ handleNotification),
/* harmony export */   openAssistantPlainTextResult: () => (/* binding */ openAssistantPlainTextResult),
/* harmony export */   openAssistantTaskResult: () => (/* binding */ openAssistantTaskResult),
/* harmony export */   openAssistantTextProcessingForm: () => (/* binding */ openAssistantTextProcessingForm),
/* harmony export */   runOrScheduleTask: () => (/* binding */ runOrScheduleTask),
...
__webpack_require__.p = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.linkTo)('assistant', 'js/'); // eslint-disable-line
 ...
 */
async function openAssistantTextProcessingForm({
  appId,
  identifier = '',
  taskType = null,
  input = '',
  ...
  const {
    default: Vue
  } = await __webpack_require__.e(/*! import() | vue-lazy */ "vue-lazy").then(__webpack_require__.bind(__webpack_require__, /*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js"));
  const {
    default: AssistantTextProcessingModal
  } = await Promise.all(/*! import() | assistant-modal-lazy */[__webpack_require__.e("vendors-node_modules_nextcloud_dialogs_dist_index_mjs"), __webpack_require__.e("vendors-node_modules_nextcloud_vue_dist_chunks_NcRichContenteditable-EZp-vrCT_mjs"), __webpack_require__.e("vue-lazy"), __webpack_require__.e("axios-lazy"), __webpack_require__.e("vendors-node_modules_nextcloud_vue_dist_Components_NcButton_mjs"), __webpack_require__.e("vendors-node_modules_nextcloud_vue_dist_Components_NcActionButton_mjs-node_modules_nextcloud_-39360c"), __webpack_require__.e("dialogs-lazy"), __webpack_require__.e("vendors-node_modules_vue-clipboard2_vue-clipboard_js-node_modules_vue-material-design-icons_C-d661dc"), __webpack_require__.e("assistant-modal-lazy")]).then(__webpack_require__.bind(__webpack_require__, /*! ./components/AssistantTextProcessingModal.vue */ "./src/components/AssistantTextProcessingModal.vue"));
  Vue.mixin({
    methods: {
      t,
      n
  ...
  return new Promise((resolve, reject) => {
    ...
    const view = new View({
      propsData: {
        isInsideViewer,
        input,
        taskType: _constants_js__WEBPACK_IMPORTED_MODULE_0__.TASK_TYPES.text_generation,
    ...
    view.$on('submit', data => {
      scheduleTask(appId, identifier, data.taskTypeId, data.input).then(response => {
    ...
    view.$on('sync-submit', data => {
      ...
      runOrScheduleTask(appId, identifier, data.taskTypeId, data.input).then(response => {
        const task = response.data?.task;
        lastTask = task;
        resolve(task);
        view.input = task.input;
        if (task.status === _constants_js__WEBPACK_IMPORTED_MODULE_0__.STATUS.successfull) {
          if (closeOnResult) {
            view.$destroy();
          } else {
            view.output = task?.output;
          }
        } else if (task.status === _constants_js__WEBPACK_IMPORTED_MODULE_0__.STATUS.scheduled) {
          view.showScheduleConfirmation = true;
        }
        view.loading = false;
    ...
    view.$on('cancel-sync-n-schedule', () => {
      ...
      scheduleTask(appId, identifier, view.textProcessingTaskTypeId, view.input).then(response => {
        view.showSyncTaskRunning = false;
        view.showScheduleConfirmation = true;
        const task = response.data?.ocs?.data?.task;
        lastTask = task;
...
async function cancelCurrentSyncTask() {
  window.assistantAbortController?.abort();
}
async function runTask(appId, identifier, taskType, input) {
  window.assistantAbortController = new AbortController();
  const {
    default: axios
  } = await __webpack_require__.e(/*! import() | axios-lazy */ "axios-lazy").then(__webpack_require__.bind(__webpack_require__, /*! @nextcloud/axios */ "./node_modules/@nextcloud/axios/dist/index.es.mjs"));
  const {
    generateUrl
  } = await Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! @nextcloud/router */ "./node_modules/@nextcloud/router/dist/index.js"));
  ...
  return axios.post(url, params, {
    signal: window.assistantAbortController.signal
  });
}
async function runOrScheduleTask(appId, identifier, taskType, input) {
  window.assistantAbortController = new AbortController();
  const {
    default: axios
  } = await __webpack_require__.e(/*! import() | axios-lazy */ "axios-lazy").then(__webpack_require__.bind(__webpack_require__, /*! @nextcloud/axios */ "./node_modules/@nextcloud/axios/dist/index.es.mjs"));
...
async function showTextProcessingTaskResult(taskId) {
  ...
  const {
    showError
  } = await Promise.all(/*! import() | dialogs-lazy */[__webpack_require__.e("vendors-node_modules_nextcloud_dialogs_dist_index_mjs"), __webpack_require__.e("vue-lazy"), __webpack_require__.e("dialogs-lazy")]).then(__webpack_require__.bind(__webpack_require__, /*! @nextcloud/dialogs */ "./node_modules/@nextcloud/dialogs/dist/index.mjs"));
  const url = generateOcsUrl('textprocessing/task/{taskId}', {
    taskId
  });
...
async function showSpeechToTextResult(notification) {
  ...
  axios.get(url, params).then(response => {
    ...
    openAssistantPlainTextResult(response.data, _constants_js__WEBPACK_IMPORTED_MODULE_0__.TASK_TYPES.speech_to_text);
  }).catch(error => {
    console.error(error);
 ...
 * @return {Promise<void>}
 */
async function openAssistantPlainTextResult(result, taskType) {
  const {
    default: Vue
  } = await __webpack_require__.e(/*! import() | vue-lazy */ "vue-lazy").then(__webpack_require__.bind(__webpack_require__, /*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js"));
  const {
    default: AssistantPlainTextModal
  } = await Promise.all(/*! import() | assistant-modal-lazy */[__webpack_require__.e("vendors-node_modules_nextcloud_dialogs_dist_index_mjs"), __webpack_require__.e("vendors-node_modules_nextcloud_vue_dist_chunks_NcRichContenteditable-EZp-vrCT_mjs"), __webpack_require__.e("vue-lazy"), __webpack_require__.e("axios-lazy"), __webpack_require__.e("vendors-node_modules_nextcloud_vue_dist_Components_NcButton_mjs"), __webpack_require__.e("vendors-node_modules_nextcloud_vue_dist_Components_NcActionButton_mjs-node_modules_nextcloud_-39360c"), __webpack_require__.e("dialogs-lazy"), __webpack_require__.e("vendors-node_modules_vue-clipboard2_vue-clipboard_js-node_modules_vue-material-design-icons_C-d661dc"), __webpack_require__.e("assistant-modal-lazy")]).then(__webpack_require__.bind(__webpack_require__, /*! ./components/AssistantPlainTextModal.vue */ "./src/components/AssistantPlainTextModal.vue"));
  Vue.mixin({
    methods: {
      t,
      n
 ...
 * @return {Promise<void>}
 */
async function openAssistantTaskResult(task) {
  const {
    showError
  } = await Promise.all(/*! import() | dialogs-lazy */[__webpack_require__.e("vendors-node_modules_nextcloud_dialogs_dist_index_mjs"), __webpack_require__.e("vue-lazy"), __webpack_require__.e("dialogs-lazy")]).then(__webpack_require__.bind(__webpack_require__, /*! @nextcloud/dialogs */ "./node_modules/@nextcloud/dialogs/dist/index.mjs"));
  const {
  ...
  view.$on('submit', data => {
    scheduleTask(task.appId, task.identifier, data.taskTypeId, data.input).then(response => {
      view.showScheduleConfirmation = true;
  ...
  view.$on('sync-submit', data => {
    ...
    view.input = data.input;
    view.textProcessingTaskTypeId = data.taskTypeId;
    runTask(task.appId, task.identifier, data.taskTypeId, data.input).then(response => {
  ...
  view.$on('cancel-sync-n-schedule', () => {
    cancelCurrentSyncTask();
    scheduleTask(task.appId, task.identifier, view.textProcessingTaskTypeId, view.input).then(response => {
      view.showSyncTaskRunning = false;
      view.showScheduleConfirmation = true;
...
async function addAssistantMenuEntry() {
  ...
  const {
    default: AssistantHeaderMenuEntry
  } = await Promise.all(/*! import() | assistant-header-lazy */[__webpack_require__.e("vendors-node_modules_nextcloud_vue_dist_Components_NcButton_mjs"), __webpack_require__.e("assistant-header-lazy")]).then(__webpack_require__.bind(__webpack_require__, /*! ./components/AssistantHeaderMenuEntry.vue */ "./src/components/AssistantHeaderMenuEntry.vue"));
  Vue.mixin({
    methods: {
      t,
      n
...
/******/ 			return "assistant-" + chunkId + ".js?v=" + {"vue-lazy":"20ba405fd113e233e1ee","vendors-node_modules_nextcloud_dialogs_dist_index_mjs":"116edbdc551fdff61758","vendors-node_modules_nextcloud_vue_dist_chunks_NcRichContenteditable-EZp-vrCT_mjs":"8c65f6dd61d3e6490dbd","axios-lazy":"707b5c7ffecef7fea8aa","vendors-node_modules_nextcloud_vue_dist_Components_NcButton_mjs":"9a37499f7af0dd9938e7","vendors-node_modules_nextcloud_vue_dist_Components_NcActionButton_mjs-node_modules_nextcloud_-39360c":"1cab7de2c3b21fd0c9d3","dialogs-lazy":"1a2d176d0ef113db4ae2","vendors-node_modules_vue-clipboard2_vue-clipboard_js-node_modules_vue-material-design-icons_C-d661dc":"4919db26820679e3ee37","assistant-modal-lazy":"38a9d1f55fb8e6fcd9e6","assistant-header-lazy":"8bfcaa1b95e00561cc35","node_modules_nextcloud_dialogs_dist_chunks_index-csK3cpe5_mjs":"2080f92e2cf149063694","vendors-node_modules_nextcloud_dialogs_dist_chunks_FilePicker-j5uGgoIq_mjs":"ced3ce05d89691110113","data_image_svg_xml_3csvg_20xmlns_27http_www_w3_org_2000_svg_27_20width_2724_27_20height_2724_-b2e651":"ed0bb5037211b0c915fe"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "assistant:";
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "/apps/assistant/js/";
/******/ 	})();
/******/ 	
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assistant_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assistant.js */ "./src/assistant.js");
...
function init() {
  if (!OCA.TpAssistant) {
     ...
     */
    OCA.TPAssistant = {
      openAssistantTextProcessingForm: _assistant_js__WEBPACK_IMPORTED_MODULE_0__.openAssistantTextProcessingForm,
      openAssistantTaskResult: _assistant_js__WEBPACK_IMPORTED_MODULE_0__.openAssistantTaskResult
    };
    (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_1__.subscribe)('notifications:action:execute', _assistant_js__WEBPACK_IMPORTED_MODULE_0__.handleNotification);
    if ((0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('assistant', 'assistant-enabled')) {
      (0,_assistant_js__WEBPACK_IMPORTED_MODULE_0__.addAssistantMenuEntry)();
    }
  }
}
init();
...
/******/ })()
;
//# sourceMappingURL=assistant-main.js.map