OC.L10N.register(
    ...
    "Nextcloud Contacts" : "Nextcloud Контакти",
    "Nextcloud user profile" : "Nextcloud кориснички профил",
    "Nextcloud Deck" : "Некстклауд палуба",
    ...
    "Nextcloud Files" : "Nextcloud Фајлови",
    ...
    "Enable Nextcloud Assistant in header" : "Укључи Nextcloud Асистента у заглављу",
    ...
    "Enable AI text generation in smart picker" : "Укључи AI генерисања текста у паметном бирачу",
    ...
    "Enable text-to-image in smart picker" : "Укључи претварања текста у слику у паметном бирачу",
    ...
    "Enable speech-to-text in smart picker" : "Укључи претварање говора у текст у паметном бирачу",
    ...
    "Enable AI image generation in smart picker" : "Укључи AI генерисања слике у паметном бирачу",
    "Enable AI transcription in smart picker" : "Укључи AI транскрипцију у паметном бирачу",
    ...
    "The server failed to process your task with ID {id}. Please inform the server administrators of this issue." : "Сервер није успео да обради ваш задатак чији је ID {id}. Молимо вас да обавестите администраторе о овом проблему.",
    ...
    "Assistant failed to schedule your task. Please try again and inform the server administrators if this issue persists." : "Асистент није успео да закаже ваш задатак. Молимо вас покушајте поново и обавестите администраторе сервера ако се овај проблем понавља."
},
