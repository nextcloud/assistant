OC.L10N.register(
    ...
    "Failed process prompt; unknown user" : "Неуспели процес захтева; непознати корисник",
    ...
    "To enable this feature, please install any AI text processing provider." : "Да бисте укључили ову функцију, молимо вас да инсталирате било који пружалац услуге AI обраде текста.",
    ...
    "Schedule an assistant task" : "Закажи задатак асистента",
    "Schedule" : "Закажи",
    "Copy" : "Копирај",
    ...
    "Free prompt smart picker" : "Паметни бирач слободног захтева",
    ...
    "The transcription could not be found. It may have been deleted." : "Није могла да се пронађе транскрипција. Можда је обрисана.",
    ...
    "This transcript does not exist or has been cleaned up" : "Транскрипт не постоји или је обрисан",
