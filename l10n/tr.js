OC.L10N.register(
    "assistant",
    {
    "Summarize using AI" : "YZ ile özetle",
    "Transcribe audio using AI" : "YZ ile sesten yazıya dönüştür",
    "Generate subtitles using AI" : "YZ ile alt yazılar oluştur",
    "Text-To-Speech using AI" : "YZ ile yazıdan konuşma dönüştür",
    "Unknown user" : "Kullanıcı bilinmiyor",
    "Skills folder not found" : "Yetenekler klasörü bulunamadı",
    "Failed to list skills" : "Yetenekler listelenemedi",
    "Skill name is too long (max %d characters)" : "Yetenek adı çok uzun (en fazla %d karakter)",
    "Skill not found" : "Yetenek bulunamadı",
    "Failed to load the skill" : "Yetenek yüklenemedi",
    "Description is too long (max %d characters)" : "Açıklama çok uzun (en fazla %d karakter)",
    "Content is too long (max %d characters)" : "İçerik çok uzun (en fazla %d karakter)",
    "Failed to store the skill" : "Yetenek kaydedilemedi",
    ...
    "Assistant task submitted" : "Yardımcı görevi gönderildi",
    "Transcription task submitted" : "Yazıya dönüştürme görevi gönderildi",
    "Subtitles task submitted" : "Alt yazı görevi gönderildi",
    "Summarization task submitted" : "Özetleme görevi gönderildi",
    "Text-to-speech task submitted" : "Yazıdan konuşmaya dönüştürme görevi gönderildi",
    ...
    "Create a Deck card" : "Bir Deste kartı oluştur",
    ...
    "AI audio transcription" : "Yapay zeka ile sesten yazıya dönüştürme",
    "AI subtitles generation" : "Yapay zeka ile alt yazı oluşturma",
    ...
    "File action has finished" : "Dosya işlemi tamamlandı",
    "{sourceFile} has been summarized in {targetFile}" : "{sourceFile}, {targetFile} içinde özetlendi",
    "{sourceFile} has been transcribed in {targetFile}" : "{sourceFile}, {targetFile} içinde yazıya dönüştürüldü",
    "{sourceFile} has been subtitled in {targetFile}" : "{sourceFile} için {targetFile} alt yazı dosyası oluşturuldu",
    "{sourceFile} has been converted to audio in {targetFile}" : "{sourceFile}, {targetFile} içinde sese dönüştürüldü",
    "{sourceFile} has been processed, {targetFile} was created" : "{sourceFile} işlendi, {targetFile} içinde oluşturuldu",
    "File action has failed" : "Dosya işlemi tamamlanamadı",
    "Summarization of {sourceFile} has failed" : "{sourceFile} özetlenemedi",
    "Transcription of {sourceFile} has failed" : "{sourceFile} yazıya dönüştürülemedi",
    "Subtitling of {sourceFile} has failed" : "{sourceFile} için alt yazılar oluşturulamadı",
    "The text-to-speech process for {sourceFile} has failed" : "{sourceFile} yazıdan sese dönüştürülemedi",
    "The processing of {sourceFile} has failed" : "{sourceFile} işlenemedi",
    "New image file has been generated" : "Yeni görsel dosyası oluşturuldu",
    ...
    "Scheduled task is pending review" : "Zamanlanmış görev değerlendirilmeyi bekliyor",
    "\"%s\" awaits your review before continuing." : "\"%s\" ilerlemeden önce değerlendirmenizi bekliyor.",
    "View scheduled task" : "Zamanlanmamış görevleri görüntüle",
    "Scheduled task succeeded" : "Zamanlanmış görev tamamlandı",
    "\"%s\" was run successfully." : "\"%s\" çalıştı.",
    "View result" : "Sonucu görüntüle",
    "Scheduled task failed" : "Zamanlanmış görev tamamlanamadı",
    ...
    "Nextcloud Deck" : "Nextcloud Deste",
    ...
    "Work with audio" : "Ses ile çalış",
    "Work with text" : "Yazı ile çalış",
    ...
    "Chat voice message" : "Sohbet ses iletisi",
    ...
    "Input transcript" : "Yazıya dönüştürme girişi",
    "Transcription of the audio input" : "Ses girişinin yazıya dönüştürülmesi",
    ...
    "The model used to translate" : "Çeviri için kullanılacak model",
    ...
    "cartoon, neutral background, sticker of %1$s" : "karikatür, nötr arka plan, %1$sçıkartması",
    "Generate sticker" : "Çıkartma oluştur",
    "Generate sticker from text" : "Yazıdan çıkartma oluştur",
    "Prompt" : "İstem",
    "Describe the sticker you would like to create" : "Oluşturmak istediğiniz çıkartmayı tanımlayın",
    ...
    "Select global skills folder" : "Genel yetenekler klasörünü seçin",
    "Select" : "Seç",
    "No folder selected" : "Herhangi bir klasör seçilmemiş",
    "Global skills folder updated" : "Genel yetenekler klasörü güncellendi",
    "Failed to set global skills folder" : "Genel yetenekler klasörüne erişilemedi",
    ...
    "The sticker generation feature won`t work without being able to generate images. Please install and enable a \"Generate image\" provider or disable the \"Generate sticker\" task type." : "Etiket oluşturma özelliği, görsel oluşturma olmadan çalışmaz. Lütfen bir \"Görsel oluşturma\" hizmeti sağlayıcısı kurun ve etkinleştirin veya \"Etiket oluşturma\" görev türünü etkisizleştirin.",
    "Select which features you want to enable" : "Kullanmak istediğiniz özellikleri seçin",
    "Nextcloud Assistant in header" : "Üst bilgide Nextcloud Yardımcı görüntülensin",
    "AI text generation in the smart picker" : "Akıllı seçicide yapay zeka ile yazı oluşturma",
    "Text-to-image in the smart picker" : "Akıllı seçicide yazıdan görsele dönüştürme",
    "Text-to-sticker in the smart picker" : "Akıllı seçicide yazıdan etikete dönüştürme",
    "Speech-to-text in the smart picker" : "Akıllı seçicide konuşmadan yazıya dönüştürme",
    "To be able to use the Assistant, please install at least one AI task processing provider." : "Yardımcıyı kullanabilmek için lütfen bir yapay zeka görevi işleme hizmeti sağlayıcısı kurun.",
    "To enable text generation in the smart picker, please install an AI task processing provider for the \"Free text to text prompt\" task type:" : "Akıllı seçicide yazı oluşturmayı etkinleştirmek için lütfen \"Serbest yazıdan yazıya istemi\" görev türü için bir yapay zeka görev işleme hizmeti sağlayıcısı kurun:",
    "To enable the sticker generation picker or the image generation picker, please install and enable a \"Generate image\" provider:" : "Etiket oluşturma seçiciyi veya görsel oluşturma seçiciyi etkinleştirmek için lütfen bir \"Görsel oluşturma\" hizmeti sağlayıcısı kurun ve etkinleştirin:",
    "To enable speech-to-text in the smart picker, please install and enable a \"Transcribe audio\" provider:" : "Akıllı seçicide konuşmadan yazıya seçeneğini etkinleştirmek için lütfen bir \"Sesi yazıya dönüştürme\" hizmeti sağlayıcısı kurun ve etkinleştirin:",
    "Data folder" : "Veri klasörü",
    "Name of the folder the assistant creates in the files of each user to store generated content. Users can override this in their personal settings. Changing it does not rename folders that already exist." : "Yardımcı tarafından her kullanıcı için oluşturulan içeriklerin kaydedileceği klasörün Dosyalar uygulamasındaki adı. Kullanıcılar bunu kişisel ayarlarında değiştirebilir. Değiştirildiğinde, zaten var olan klasörler yeniden adlandırılmaz.",
    "Default data folder name" : "Varsayılan veri klasörü adı",
    ...
    "It is passed on to the LLMs to better generate a chat title" : "Bir sohbet başlığını daha iyi oluşturmak için dil öğrenme modellerine iletilir",
    ...
    "Global Agent Skills" : "Genel aracı yetenekleri",
    "Select a folder containing skills (sub-folders, each holding a SKILL.md file). These will be available to all users in addition to their personal skills in \"Chat with AI\". The folder is resolved from the filesystem of the admin who set it." : "Yeteneklerin bulunduğu bir klasör seçin (her birinde bir SKILL.md dosyası bulunan alt klasörler). Bunlar, \"Yapay zeka ile sohbet\" bölümündeki kişisel yeteneklere ek olarak tüm kullanıcılara sunulur. Klasör, onu ayarlayan yöneticinin dosya sisteminden çözümlenir.",
    "Clear" : "Temizle",
    "Selected folder" : "Seçilmiş klasör",
    "Set by" : "Ayarlayan",
    "No global skills folder configured" : "Yetenekler klasörü yapılandırılmamış",
    ...
    "Nextcloud Assistant header menu entry" : "Nextcloud Yardımcı üst bilgi menüsü kaydı",
    ...
    "Type or paste the text to extract the topics from" : "Konuların çıkarılacağı yazıyı yazın veya yapıştırın",
    ...
    "Information sources & actions" : "Bilgi kaynakları ve işlemler",
    "Reasoning…" : "Akıl yürütme...",
    "Ask assistant, what's the weather today" : "Yardımcıya bugün havanın nasıl olacağını sorun",
    ...
    "Ask assistant to create a deck card in my Project board in the todo stack for creating the presentation" : "Yardımcıdan sunumu oluşturmak için yapılacaklar yığınıdaki proje panosunda bir Deste kartı oluşturmasını isteyin",
    "Create a deck card in my Project board in the todo stack for creating the presentation" : "Sunumu oluşturmak için yapılacaklar yığınındaki proje panomda bir Deste kartı oluştur",
    "Ask assistant to generate a slide deck about the features of Nextcloud" : "Yardımcıdan Nextcloud özellikleri ile ilgili bir slayt destesi oluşturmasını isteyin",
    "Generate a slide deck about the features of Nextcloud" : "Nextcloud özellikleri ile ilgili bir slayt destesi oluştur",
    ...
    "Output shown here is generated by AI. Make sure to always double-check." : "Bu çıktı yapay zeka tarafından oluşturuldu. Her zaman iki kez kontrol ettiğinizden emin olun.",
    "Messages should not be longer than {maxLength} characters (currently {length})." : "İletiler en fazla {maxLength} karakter uzunluğunda olmalı (şu anda {length}).",
    "Conversation deletion" : "Görüşme silme",
    ...
    "The text must be shorter than or equal to {maxLength} characters, currently {length}" : "Yazı en çok {maxLength} karakter uzunluğunda olmalı. Şu anda {length} karakter",
    ...
    "Context Chat has not finished indexing all your documents yet, it may not be able to answer your questions, yet." : "Context Chat tüm belgelerinizi dizine eklemeyi bitirmemiş. Henüz sorularınızı yanıtlayamayabilir.",
    "Selective context" : "Seçici bağlam",
    "No sources referenced" : "Başvurulan bir kaynak yok",
    "Prompt cannot be empty." : "İstem boş olamaz.",
    "Image generation task has been scheduled." : "Görsel oluşturma görevi zamanlandı.",
    "Failed to schedule image generation task." : "Görsel oluşturma görevi zamanlanamadı.",
    "Generate new image using AI" : "YZ ile yeni görsel oluştur",
    "The result image would be placed in the current folder." : "Sonuç görseli geçerli klasöre kaydedilir.",
    "The resulting images are generated by AI. Make sure to double-check and adjust." : "Sonuç görselleri yapay zeka tarafından oluşturuldu. İki kez kontrol edip ayarladığınızdan emin olun.",
    "Generate new image" : "Yeni görsel oluştur",
    "Describe the image you want to generate" : "Oluşturmak istediğiniz görseli tanımlayın",
    "No providers found" : "Herhangi bir hizmet sağlayıcı bulunamadı",
    "Image generation is not available." : "Görsel oluşturma kullanılamıyor.",
    ...
    "Auto-play audio chat responses" : "Sesli sohbet yanıtları otomatik oynatılsın",
    "AI text generation in smart picker" : "Akıllı seçicide yapay zeka ile yazı oluşturma",
    "AI image generation in smart picker" : "Akıllı seçicide yapay zeka ile görsel oluşturma",
    "AI sticker generation in smart picker" : "Akıllı seçicide yapay zeka ile etiket oluşturma",
    "AI transcription in smart picker" : "Akıllı seçicide yapay zeka ile yazıya dönüştürme",
    ...
    "Where the assistant stores content it generates for you. Leave empty to use the name your administrator has set. Changing it does not move files that are already there." : "Yardımcının sizin için oluşturduğu içerikleri kaydettiği konum. Yöneticinizin belirlediği adın kullanılması için boş bırakın. Değiştirildiğinde, orada var olan dosyaların taşınmayacağını unutmayın.",
    "Folder name" : "Klasör adı",
    "Remembered conversations" : "Hatırlanan görüşmeler",
    "The following conversations are remembered by the Assistant Chat and will be taken into account for every new conversation:" : "Aşağıdaki görüşmeler Yardımcı sohbeti tarafından hatırlanır ve her yeni görüşme için dikkate alınır:",
    ...
    "Access to the microphone was denied. Please check you allowed this page to access the microphone." : "Mikrofona erişme izni verilmemiş. Lütfen bu sayfa için mikrofona erişme izni verdiğinizden emin olun.",
    "Microphone either not available or disabled in settings. Check you are accessing this page with HTTPS or adjust your browser settings." : "Mikrofon bulunamadı ya da ayarlardan kapatılmış. Bu sayfaya HTTPS ile erişip erişip erişmediğinizi denetleyin ve tarayıcı ayarlarınıza bakın.",
    ...
    "Advanced" : "Gelişmiş",
    "Choose a text file" : "Bir yazı dosyası seçin",
    "Warning: The input text exceeds the maximum length of {limit} characters (currently {length})." : "Uyarı: Giriş yazısı olabilecek en fazla {limit} karakter uzunluğunu aşıyor (şu anda {length}).",
    "Unexpected response from text parser" : "Yazı işleyiciden beklenmeyen bir yanıt alındı",
    ...
    "Improve with new instructions" : "Yeni yönergeler ile iyileştirin",
    "Improve this text" : "Bu yazıyı iyileştir",
    ...
    "Please inform the server administrators of this issue." : "Lütfen bu sorunu sunucu yöneticilerine iletin.",
    "No last task type available, falling back to default" : "Kullanılabilecek bir son görev türü yok, varsayılan tür kullanılıyor",
    ...
    "Summarization AI task submitted." : "Özetleme YZ görevi gönderildi.",
    ...
    "Text-to-Speech AI task submitted." : "Yazıdan konuşmaya dönüştürme YZ görevi gönderildi.",
    ...
    "Transcription AI task submitted." : "Yazıya dönüştürme YZ görevi gönderildi.",
    ...
    "AI subtitles task submitted." : "Alt yazı YZ görevi gönderildi.",
    "It can also be checked in the Assistant in the \"Work with audio -> Generate subtitles\" menu." : "Ayrıca Yardımcı içinde \"Ses ile çalış -> Alt yazı oluştur\" menüsünde de bakabilirsiniz.",
    "Assistant task submitted successfully" : "Yardımcı görevi gönderildi",
    "Transcription task submitted successfully" : "Yazıya dönüştürme görevi gönderildi",
