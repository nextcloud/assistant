OC.L10N.register(
    ...
    "To enable this feature, please install an AI task processing provider for the free prompt task type:" : "Bu özelliği kullanıma almak için lütfen serbest soru görevi türü için bir Yapay Zeka görevi işleme hizmeti sağlayıcısı kurun:",
    "Text-to-image smart picker" : "Yazıdan görsele akıllı seçici<",
    "To enable this feature, please install a text-to-image provider:" : "Bu özelliği kullanıma almak için lütfen bir yazıdan görsele hizmeti sağlayıcısı kurun:",
    "Speech-to-text smart picker" : "Konuşmadan yazıya akıllı seçici",
    "To enable this feature, please install a speech-to-text provider:" : "Bu özelliği kullanıma almak için lütfen bir konuşmadan yazıya hizmeti sağlayıcısı kurun:",
    ...
    "To enable this feature, please install an AI text processing provider for the free prompt task type." : "Bu özelliği kullanıma almak için lütfen serbest soru görevi türü için bir Yapay Zeka yazı işleme hizmeti sağlayıcısı kurun.",
    "To enable this feature, please install a text-to-image provider." : "Bu özelliği kullanıma almak için lütfen bir yazıdan görsele hizmeti sağlayıcısı kurun.",
    "To enable this feature, please install a speech-to-text provider." : "Bu özelliği kullanıma almak için lütfen bir konuşmadan yazıya hizmeti sağlayıcısı kurun.",
