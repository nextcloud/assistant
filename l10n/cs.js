OC.L10N.register(
    ...
    "Warning: The input text exceeds the maximum length of {limit} characters (currently {length})." : "Varování: Vstupní text překračuje maximální délku {limit} znaků (současně {length}).",
