OC.L10N.register(
    ...
    "Enable Nextcloud Assistant in header" : "Ativar o Nextcloud Assistente no cabeçalho",
    "To be able to use this feature, please install at least one AI task processing provider." : "Para poder usar este recurso, instale pelo menos um provedor de processamento de tarefas de IA.",
    "Enable AI text generation in smart picker" : "Ativar geração de texto por IA no seletor inteligente",
    "To enable this feature, please install an AI task processing provider for the free prompt task type:" : "Para ativar este recurso, instale um provedor de processamento de tarefas de IA para o tipo de tarefa de prompt livre:",
    "Enable text-to-image in smart picker" : "Ativar texto-para-imagem no seletor inteligente",
    ...
    "Enable speech-to-text in smart picker" : "Ativar fala-para-texto no seletor inteligente",
    ...
    "It is passed on to the LLMs to let it know what to do" : "São transmitidas aos LLMs para que eles saibam o que fazer",
    ...
    "The server failed to process your task with ID {id}. Please inform the server administrators of this issue." : "O servidor não conseguiu processar sua tarefa com o ID {id}. Informe os administradores do servidor sobre este problema.",
    ...
    "Assistant failed to schedule your task. Please try again and inform the server administrators if this issue persists." : "O Assistente não conseguiu agendar sua tarefa. Tente novamente e informe os administradores do servidor se o problema persistir."
},
