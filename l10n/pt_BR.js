OC.L10N.register(
    ...
    "Generate subtitles using AI" : "Gerar legendas usando IA",
    "Text-To-Speech using AI" : "Conversão de texto em fala usando IA",
    "Unknown user" : "Usuário desconhecido",
    "Skills folder not found" : "Pasta de habilidades não encontrada",
    "Failed to list skills" : "Falha ao listar as habilidades",
    "Skill name is too long (max %d characters)" : "Nome de habilidade é muito longo (máximo de %d caracteres)",
    "Skill not found" : "Habilidade não encontrada",
    "Failed to load the skill" : "Falha ao carregar a habilidade",
    "Description is too long (max %d characters)" : "A descrição é muito longa (máximo de %d caracteres)",
    "Content is too long (max %d characters)" : "O conteúdo é muito longo (máximo de %d caracteres)",
    ...
    "Text-to-speech task submitted" : "Tarefa de conversão de texto em voz enviada",
    ...
    "AI subtitles generation" : "Geração de legendas por IA",
    ...
    "{sourceFile} has been subtitled in {targetFile}" : "O arquivo {sourceFile} foi legendado no arquivo {targetFile}",
    ...
    "Summarization of {sourceFile} has failed" : "Resumo de {sourceFile} falhou",
    "Transcription of {sourceFile} has failed" : "Transcrição de {sourceFile} falhou",
    "Subtitling of {sourceFile} has failed" : "Falha na criação de legendas para {sourceFile}",
    ...
    "List calendar tasks" : "Listar tarefas do calendário",
    ...
    "Select global skills folder" : "Selecione a pasta de habilidades globais",
    "Select" : "Selecionar",
    "No folder selected" : "Nenhuma pasta selecionada",
    "Global skills folder updated" : "Pasta de habilidades globais atualizada",
    "Failed to set global skills folder" : "Falha ao definir a pasta de habilidades globais",
    ...
    "Text-to-sticker in the smart picker" : "Texto-para-sticker no seletor inteligente",
    ...
    "Name of the folder the assistant creates in the files of each user to store generated content. Users can override this in their personal settings. Changing it does not rename folders that already exist." : "Nome da pasta que o assistente cria em Arquivos de cada usuário para armazenar o conteúdo gerado. Os usuários podem alterar essa configuração em suas configurações pessoais. A alteração não renomeia as pastas que já existem.",
    "Default data folder name" : "Nome padrão da pasta de dados",
    ...
    "Global Agent Skills" : "Habilidades globais de agente",
    "Select a folder containing skills (sub-folders, each holding a SKILL.md file). These will be available to all users in addition to their personal skills in \"Chat with AI\". The folder is resolved from the filesystem of the admin who set it." : "Selecione uma pasta que contenha habilidades (subpastas, cada uma contendo um arquivo SKILL.md). Essas habilidades ficarão disponíveis para todos os usuários, além das habilidades pessoais de cada um, na seção “Bate-papo com IA”. A pasta é identificada a partir do sistema de arquivos do administrador que a configurou.",
    "Clear" : "Limpar",
    "Selected folder" : "Selecionar pasta",
    "Set by" : "Definida por",
    "No global skills folder configured" : "Nenhuma pasta de habilidades globais configurada",
    ...
    "Ask assistant to create a deck card in my Project board in the todo stack for creating the presentation" : "Peça ao assistente para criar um cartão de Deck no quadro de projetos, na pilha de tarefas pendentes, para a criação da apresentação",
    "Create a deck card in my Project board in the todo stack for creating the presentation" : "Crie um cartão do Deck no meu quadro de projetos, na pilha de tarefas pendentes, para a criação da apresentação",
    ...
    "AI transcription in smart picker" : "Transcrição por IA no seletor inteligente",
    ...
    "Where the assistant stores content it generates for you. Leave empty to use the name your administrator has set. Changing it does not move files that are already there." : "Local onde o assistente armazena o conteúdo que gera para você. Deixe em branco para usar o nome definido pelo seu administrador. Alterar esse nome não move os arquivos que já estão lá.",
    ...
    "Scheduled" : "Agendado",
    "_{n} image generated_::_{n} images generated_" : ["{n} imagem gerada","{n} de imagens geradas","{n} imagens geradas"],
    ...
    "Summarization AI task submitted." : "Tarefa de resumo com IA enviada.",
    ...
    "Text-to-Speech AI task submitted." : "Tarefa de conversão de texto em voz com IA enviada.",
    ...
    "Transcription AI task submitted." : "Tarefa de transcrição com IA enviada.",
    ...
    "AI subtitles task submitted." : "Tarefa de legendagem com IA enviada.",
    "It can also be checked in the Assistant in the \"Work with audio -> Generate subtitles\" menu." : "Isso também pode ser verificado no Assistente, no menu “Trabalhar com áudio -> Gerar legendas”.",
    ...
    "Summarization task submitted successfully" : "Tarefa de resumo enviada com sucesso",
