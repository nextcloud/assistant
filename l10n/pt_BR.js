OC.L10N.register(
    ...
    "Assistant File Transcription" : "Transcrição de Arquivos do Assistente",
    ...
    "Nextcloud User Profile" : "Perfil do Usuário do Nextcloud",
    ...
    "DuckDuckGo Web Search" : "Pesquisa de Web DuckDuckGo",
    ...
    "AI text generation smart picker" : "Seletor inteligente de geração de texto por IA",
    ...
    "Speech-to-text smart picker" : "Seletor inteligente de voz-para-texto",
    "To enable this feature, please install a speech-to-text provider:" : "Para ativar este recurso, instale um provedor de voz-para-texto:",
    ...
    "AI image generation smart picker" : "Seletor inteligente de geração de imagens de IA",
    ...
    "You will receive a notification when it has finished" : "Você receberá uma notificação quando ela for concluída",
    ...
    "Running" : "Corrida",
    "Scheduled" : "Agendada",
    "_{n} image generated_::_{n} images generated_" : ["{n} imagem gerada","{n} imagens geradas","{n} imagens geradas"],
    "_{n} image scheduled_::_{n} images scheduled_" : ["{n} imagem agendada","{n} imagens agendadas","{n} imagens agendadas"],
    ...
    "No Speech-to-Text provider found, install one from the app store to use this feature." : "Nenhum provedor de Voz-para-Texto foi encontrado. Instale um da loja de aplicativos para usar este recurso.",
    ...
    "Failed to get prompt history" : "Falha ao obter o histórico de prompt",
    ...
    "Output" : "Saída",
    "Copy output text to clipboard" : "Copiar o texto de saída para a área de transferência",
    "Reset the output value to the originally generated one" : "Redefinir o valor de saída para o gerado originalmente",
    "Reset" : "Redefinir",
    "Back to the assistant" : "Voltar ao assistente",
    ...
    "Run a task" : "Executar uma tarefa",
    "Loading conversations..." : "Carregando conversas…",
    "Edit Title" : "Editar Título",
    "Generate Title" : "Gerar Título",
    "Loading messages..." : "Carregando mensagens…",
    ...
    "Choose Audio File" : "Escolher Arquivo de Áudio",
    ...
    "_{n} image has been generated_::_{n} images have been generated_" : ["{n} imagem foi gerada","{n} imagens foram geradas","{n} imagens foram geradas"],
    "_Generation of {n} image is scheduled_::_Generation of {n} images is scheduled_" : ["A geração de {n} imagem está agendada","A geração de {n} imagens está agendada","A geração de {n} imagens está agendada"],
    ...
    "Image generation failed" : "Geração de imagem falhou",
    "This generation has no visible images" : "Esta geração não tem imagens visíveis",
    ...
    "The task could not be found. It may have been deleted." : "A tarefa não foi encontrada. Talvez foi excluído.",
    ...
    "Image generation cancel error" : "Erro de cancelamento da geração de imagem",
    ...
    "Submit image(s) generated by AI" : "Enviar imagem ou imagens geradas pela IA",
    "Send" : "Enviar",
    ...
    "Copy the link to this generation to clipboard" : "Copiar o link desta geração para a área de transferência",
