OC.L10N.register(
    ...
    "Choose a task" : "Escolha uma tarefa",
    "Type some text" : "Digite algum texto",
    "Result" : "Resultado",
    "Submit assistant task" : "Enviar tarefa do assistente",
    "Submit" : "Enviar",
    "Copy task output" : "Copiar saída da tarefa",
    "Copy" : "Copiar",
    "Try again" : "Tente novamente",
    "Result could not be copied to clipboard" : "O resultado não pôde ser copiado para a área de transferência",
    "Your task has been scheduled, you will receive a notification when it has finished" : "Sua tarefa foi agendada, você receberá uma notificação quando terminar",
    "Close" : "Fechar",
