OC.L10N.register(
    ...
    "Nextcloud Assistant header menu entry" : "Nextcloud Assistantのヘッダーメニューエントリ",
    ...
    "Text-to-speech task submitted successfully." : "テキスト読み上げタスクが正常に送信されました。",
    "It can also be checked in the Assistant in the \"Work with audio -> Generate speech\" menu." : "アシスタントの「オーディオの操作 -> 音声の生成」メニューでも確認することができます。",
    "It can also be checked in the Assistant in the \"Work with audio -> Transcribe audio\" menu." : "アシスタントの「音声の操作 -> 音声の文字起こし」メニューでも確認することができます。"
},
"nplurals=1; plural=0;");
