OC.L10N.register(
    ...
    "Failed to cancel generation; unknown user" : "生成のキャンセルに失敗しました; 不明ユーザー",
    "Some internal error occurred. Contact your sysadmin for more info." : "内部エラーが発生しました。詳細については、システム管理者にお問い合わせください。",
    "No Speech-to-Text provider found, install one from the app store to use this feature." : "Speech-to-Text プロバイダーが見つかりません。この機能を使用するには、アプリストアからプロバイダーをインストールしてください。",
    ...
    "Days until generated images are deleted if they are not viewed" : "生成された画像が閲覧されなかった場合に削除されるまでの日数",
    ...
    "Show previous tasks" : "以前のタスクを表示",
    "Run a task" : "タスクを実行",
    "Copy" : "コピー",
    "Try again" : "もう一度やり直してください",
    "Send request" : "リクエストを送信",
    "Select Files/Folders" : "ファイル/フォルダを選択",
    "Select Providers" : "プロバイダーの選択",
    "Choose Files/Folders" : "ファイル/フォルダを選択",
    ...
    "Assistant options saved" : "アシスタントオプション保存",
