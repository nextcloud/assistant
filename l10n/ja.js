OC.L10N.register(
    ...
    "View task" : "タスクを表示",
    "File action has finished" : "ファイル操作が完了しました",
    "File action has failed" : "ファイル操作に失敗しました",
    ...
    "Image file generation has failed" : "画像ファイルの生成に失敗しました",
    "AI sticker generation" : "AIステッカー生成",
    "Assistant audio transcription" : "アシスタント音声文字起こし",
    "Assistant document generation" : "アシスタントドキュメント生成",
    "Nextcloud Calendar" : "Nextcloudカレンダー",
    "Nextcloud Tasks" : "Nextcloud タスク",
    ...
    "Generate sticker from text" : "画像からステッカーを生成する",
    "Prompt" : "プロンプト",
    "Describe the sticker you would like to create" : "作成したいステッカーを説明する",
    "Output stickers" : "出力ステッカー",
    "The generated sticker" : "出力ステッカー",
    ...
    "Failed to parse some files" : "一部のファイルの解析に失敗しました",
    ...
    "Less" : "以下",
    "More" : "さらに表示",
    "The Assistant wants to perform sensitive actions on your behalf." : "アシスタントはあなたに代わって機密性の高い操作を実行しようとしています。",
    "Cancel" : "キャンセル",
    ...
    "Output shown here is generated by AI. Make sure to always double-check." : "ここで表示される出力はAIによって生成されます。必ず二重チェックを行ってください。",
    "Conversation deletion" : "会話の削除",
    ...
    "The result image would be placed in the current folder." : "結果画像は現在のフォルダーに配置されます。",
    "Describe the image you want to generate" : "生成する画像を記述します",
    "No providers found" : "プロバイダが見つかりません",
    "Image generation is not available." : "画像生成は利用できません。",
    "Generate image" : "画像生成",
    "tool" : "ツール",
    "integration" : "統合",
    ...
    "This may take a few minutes…" : "これには数分かかることがあります…",
    ...
    "Other" : "その他",
    "Access to the microphone was denied. Please check you allowed this page to access the microphone." : "マイクへのアクセスが拒否されました。このページにマイクへのアクセスを許可したことを確認してください。",
    ...
    "This output file has been saved in {path}" : "この出力ファイルは{path}に保存されています",
    ...
    "The current Assistant task could not be found" : "現在のアシスタントタスクが見つかりませんでした",
