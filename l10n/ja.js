OC.L10N.register(
    ...
    "To enable this feature, please install an AI task processing provider for the free prompt task type:" : "この機能を有効にするには、自由なプロンプトタスクを処理できるタイプのAIタスク処理プロバイダーをインストールしてください:",
