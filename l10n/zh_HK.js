OC.L10N.register(
    ...
    "Failed process prompt; unknown user" : "處理提示失敗；用戶不詳",
    ...
    "The transcription could not be found. It may have been deleted." : "找不到所需的抄本內容。可能已被刪除。",
    "Record Audio" : "錄製語音",
    ...
    "This transcript does not exist or has been cleaned up" : "抄本不存在或已被刪除",
