OC.L10N.register(
    ...
    "Enable Nextcloud Assistant in header" : "Habilitar el asistente de Nextcloud en la cabecera",
    "To be able to use this feature, please install at least one AI task processing provider." : "Para poder utilizar esta característica, por favor, instale al menos un proveedor de procesamiento de tareas de IA.",
    "Enable AI text generation in smart picker" : "Habilitar la generación de texto mediante IA en el selector inteligente",
    "To enable this feature, please install an AI task processing provider for the free prompt task type:" : "Para habilitar esta característica, por favor, instale un proveedor de procesamiento de tareas de IA para el tipo de tarea de prompt libre:",
    "Enable text-to-image in smart picker" : "Habilitar el texto a imágenes en el selector inteligente",
    "Enable text-to-sticker in smart picker" : "Habilitar texto a sticker en el selector inteligente",
    ...
    "Enable speech-to-text in smart picker" : "Habilitar voz a texto en el selector inteligente",
    ...
    "Enable AI image generation in smart picker" : "Habilitar la generación de imágenes mediante IA en el selector inteligente",
    "Enable AI sticker generation in smart picker" : "Habilitar la generación de stickers mediante IA en el selector inteligente",
    "Enable AI transcription in smart picker" : "Habilitar la transcripción mediante IA en el selector inteligente",
