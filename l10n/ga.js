OC.L10N.register(
    "assistant",
    {
    "Summarize using AI" : "Achoimrigh ag baint úsáide as AI",
    "Transcribe audio using AI" : "Tras-scríobh fuaim ag baint úsáide as hintleacht shaorga",
    "Generate subtitles using AI" : "Gin fotheidil ag baint úsáide as AI",
    "Text-To-Speech using AI" : "Téacs-go-Caint ag baint úsáide as AI",
    "Unknown user" : "Úsáideoir anaithnid",
    "Skills folder not found" : "Níor aimsíodh fillteán scileanna",
    "Failed to list skills" : "Theip ar scileanna a liostáil",
    "Skill name is too long (max %d characters)" : "Tá ainm na scile rófhada (uasmhéid %d carachtar)",
    "Skill not found" : "Níor aimsíodh an scil",
    "Failed to load the skill" : "Theip ar an scil a luchtú",
    "Description is too long (max %d characters)" : "Tá an cur síos rófhada (uasmhéid %d carachtar)",
    "Content is too long (max %d characters)" : "Tá an t-ábhar rófhada (uasmhéid %d carachtar)",
    "Failed to store the skill" : "Theip ar an scil a stóráil",
    ...
    "Assistant task submitted" : "Tasc cúnta curtha isteach",
    "Transcription task submitted" : "Tasc trascríobh curtha isteach",
    "Subtitles task submitted" : "Cuireadh tasc fotheideal isteach",
    "Summarization task submitted" : "Tasc achoimre curtha isteach",
    "Text-to-speech task submitted" : "Tasc téacs-go-hurlabhra curtha isteach",
    ...
    "Move file" : "Bog comhad",
    "Copy file" : "Cóipeáil comhad",
    "Delete file" : "Scrios an comhad",
    "Create bookmark" : "Cruthaigh leabharmharc",
    "Update bookmark" : "Nuashonraigh leabharmharc",
    "Delete bookmark" : "Scrios leabharmharc",
    "Create bookmark folder" : "Cruthaigh fillteán leabharmharcanna",
    "Create team" : "Cruthaigh foireann",
    "Add member to team" : "Cuir ball leis an bhfoireann",
    "Remove member from team" : "Bain ball den fhoireann",
    "Update team" : "Foireann nuashonraithe",
    "Delete team" : "Scrios an fhoireann",
    "Share with team" : "Comhroinn leis an bhfoireann",
    "Create form" : "Cruthaigh foirm",
    "Add question to form" : "Cuir ceist leis an bhfoirm",
    "Delete form" : "Scrios foirm",
    "Update form settings" : "Nuashonraigh socruithe foirme",
    "Share with user" : "Comhroinn leis an úsáideoir",
    "Share with group" : "Roinn leis an ngrúpa",
    "Update share permissions" : "Nuashonraigh ceadanna comhroinnte",
    ...
    "Could not find session" : "Níorbh fhéidir seisiún a aimsiú",
    "User is not logged in" : "Níl an t-úsáideoir logáilte isteach",
    ...
    "Failed to schedule message generation" : "Theip ar sceidealú giniúint teachtaireachta",
    ...
    "AI subtitles generation" : "Giniúint fotheidil AI",
    ...
    "{sourceFile} has been subtitled in {targetFile}" : "Tá fotheidil curtha ar {sourceFile} i {targetFile}",
    ...
    "Subtitling of {sourceFile} has failed" : "Theip ar fhotheidealú {sourceFile}",
    ...
    "Complete calendar task" : "Críochnaigh tasc féilire",
    "Nextcloud Talk" : "Caint Nextcloud",
    "Nextcloud Files" : "Comhaid Nextcloud",
    "OpenProject" : "OpenProject",
    "Delete calendar task" : "Scrios tasc féilire",
    ...
    "Nextcloud User Search" : "Cuardach Úsáideora Nextcloud",
    ...
    "Get file content by link" : "Faigh ábhar comhaid trí nasc",
    "Get form details" : "Faigh sonraí an fhoirm",
    "Get form responses" : "Faigh freagraí foirmeacha",
    "HERE Public transport API" : "API iompair phoiblí ANSEO",
    "Get share info" : "Faigh eolas comhroinnte",
    "List bookmark folders" : "Liostaigh fillteáin leabharmharcanna",
    "List bookmark tags" : "Liostaigh clibeanna leabharmharcanna",
    "List bookmarks" : "Liostaigh leabharmharcanna",
    "List forms" : "Foirmeacha liosta",
    "List shares" : "Scaireanna liosta",
    "List calendar tasks" : "Liostaigh tascanna féilire",
    "List user groups" : "Liostaigh grúpaí úsáideoirí",
    "Search bookmarks" : "Cuardaigh leabharmharcanna",
    "Nextcloud Mail" : "Ríomhphost Nextcloud",
    "Assistant audio transcription" : "Tras-scríobh fuaime Cúnta",
    "Update calendar task" : "Nuashonraigh tasc féilire",
    ...
    "Chat with an AI model." : "Comhráigh le samhail AI.",
    ...
    "Failed to encode attachments" : "Theip ar cheangaltáin a ionchódú",
    "Message not found" : "Níor aimsíodh an teachtaireacht",
    "No user message found in this session" : "Níor aimsíodh aon teachtaireacht úsáideora sa seisiún seo",
    "No human message found in this session" : "Níor aimsíodh aon teachtaireacht dhaonna sa seisiún seo",
    "Assistant" : "Cúntóir",
    ...
    "Select global skills folder" : "Roghnaigh fillteán scileanna domhanda",
    "Select" : "Roghnaigh",
    "No folder selected" : "Níl aon fhillteán roghnaithe",
    "Global skills folder updated" : "Fillteán scileanna domhanda nuashonraithe",
    "Failed to set global skills folder" : "Theip ar fhillteán scileanna domhanda a shocrú",
    ...
    "Nextcloud Assistant in header" : "Cúntóir Nextcloud sa cheanntásc",
    ...
    "Name of the folder the assistant creates in the files of each user to store generated content. Users can override this in their personal settings. Changing it does not rename folders that already exist." : "Ainm an fhillteáin a chruthaíonn an cúntóir i gcomhaid gach úsáideora chun ábhar ginte a stóráil. Is féidir le húsáideoirí é seo a shárú ina socruithe pearsanta. Ní athraíonn athrú a dhéanamh ar fhillteáin atá ann cheana féin.",
    "Default data folder name" : "Ainm réamhshocraithe an fhillteáin sonraí",
    ...
    "Global Agent Skills" : "Scileanna Gníomhaire Domhanda",
    "Select a folder containing skills (sub-folders, each holding a SKILL.md file). These will be available to all users in addition to their personal skills in \"Chat with AI\". The folder is resolved from the filesystem of the admin who set it." : "Roghnaigh fillteán ina bhfuil scileanna (fo-fhillteáin, agus comhad SKILL.md i ngach ceann acu). Beidh siad seo ar fáil do gach úsáideoir sa bhreis ar a gcuid scileanna pearsanta i \"Comhrá le hintleacht shaorga\". Réitítear an fillteán ó chóras comhad an riarthóra a shocraigh é.",
    "Clear" : "Glan",
    "Selected folder" : "Fillteán roghnaithe",
    "Set by" : "Socraithe ag",
    "No global skills folder configured" : "Níl aon fhillteán scileanna domhanda cumraithe",
    ...
    "Nextcloud Assistant header menu entry" : "Iontráil roghchláir ceanntásca Cúntóir Nextcloud",
    ...
    "Ask assistant, what's the weather today" : "Fiafraigh den chúntóir, cén aimsir atá ann inniu",
    ...
    "Generate new image using AI" : "Íomhá nua a ghiniúint ag baint úsáide as AI",
    "The result image would be placed in the current folder." : "Chuirfí an íomhá toraidh san fhillteán reatha.",
    "The resulting images are generated by AI. Make sure to double-check and adjust." : "Gintear na híomhánna a eascraíonn as sin le hintleacht shaorga. Déan cinnte iad a sheiceáil faoi dhó agus iad a choigeartú.",
    ...
    "Where the assistant stores content it generates for you. Leave empty to use the name your administrator has set. Changing it does not move files that are already there." : "An áit a stórálann an cúntóir ábhar a ghineann sé duit. Fág folamh chun an t-ainm atá socraithe ag do riarthóir a úsáid. Ní bhogtar comhaid atá ann cheana féin mar gheall ar athrú a dhéanamh air.",
    "Folder name" : "Ainm fillteáin",
    "Remembered conversations" : "Comhráite cuimhne",
    ...
    "Drop files here to upload them" : "Scaoil comhaid anseo le go n-uaslódáilfidh tú iad",
    "Select from Nextcloud" : "Roghnaigh ó Nextcloud",
    ...
    "Drop a file here to upload it" : "Scaoil comhad anseo le go n-uaslódáilfidh tú é",
    ...
    "Double-click to edit" : "Cliceáil faoi dhó le heagarthóireacht",
    "Improve with new instructions" : "Feabhsaigh le nua treoracha",
    "Improve this text" : "Feabhsaigh an téacs seo",
    ...
    "Something went wrong when scheduling the task" : "Chuaigh rud éigin mícheart agus an tasc á sceidealú",
    ...
    "Summarization AI task submitted." : "Cuireadh achoimre ar thasc AI isteach.",
    ...
    "Text-to-Speech AI task submitted." : "Tasc AI Téacs-go-Caint curtha isteach.",
    ...
    "Transcription AI task submitted." : "Cuireadh tasc trascríobh AI isteach.",
    ...
    "AI subtitles task submitted." : "Tasc fotheidil AI curtha isteach.",
    "It can also be checked in the Assistant in the \"Work with audio -> Generate subtitles\" menu." : "Is féidir é a sheiceáil sa Chúntóir sa roghchlár \"Oibrigh le fuaim -> Gin fotheidil\".",
