OC.L10N.register(
    "assistant",
    {
    "Summarize using AI" : "Summarize using AI",
    "Transcribe audio using AI" : "Transcribe audio using AI",
    "Generate subtitles using AI" : "Generate subtitles using AI",
    "Text-To-Speech using AI" : "Text-To-Speech using AI",
    "Unknown user" : "Unknown user",
    "Skills folder not found" : "Skills folder not found",
    "Failed to list skills" : "Failed to list skills",
    "Skill name is too long (max %d characters)" : "Skill name is too long (max %d characters)",
    "Skill not found" : "Skill not found",
    "Failed to load the skill" : "Failed to load the skill",
    "Description is too long (max %d characters)" : "Description is too long (max %d characters)",
    "Content is too long (max %d characters)" : "Content is too long (max %d characters)",
    "Failed to store the skill" : "Failed to store the skill",
    ...
    "Assistant task submitted" : "Assistant task submitted",
    "Transcription task submitted" : "Transcription task submitted",
    "Subtitles task submitted" : "Subtitles task submitted",
    "Summarization task submitted" : "Summarization task submitted",
    "Text-to-speech task submitted" : "Text-to-speech task submitted",
    ...
    "Create bookmark folder" : "Create bookmark folder",
    ...
    "Add question to form" : "Add question to form",
    ...
    "Failed to schedule message generation" : "Failed to schedule message generation",
    ...
    "AI subtitles generation" : "AI subtitles generation",
    ...
    "View task" : "View task",
    "File action has finished" : "File action has finished",
    "{sourceFile} has been summarized in {targetFile}" : "{sourceFile} has been summarised in {targetFile}",
    "{sourceFile} has been transcribed in {targetFile}" : "{sourceFile} has been transcribed in {targetFile}",
    "{sourceFile} has been subtitled in {targetFile}" : "{sourceFile} has been subtitled in {targetFile}",
    "{sourceFile} has been converted to audio in {targetFile}" : "{sourceFile} has been converted to audio in {targetFile}",
    "{sourceFile} has been processed, {targetFile} was created" : "{sourceFile} has been processed, {targetFile} was created",
    "File action has failed" : "File action has failed",
    "Summarization of {sourceFile} has failed" : "Summarisation of {sourceFile} has failed",
    "Transcription of {sourceFile} has failed" : "Transcription of {sourceFile} has failed",
    "Subtitling of {sourceFile} has failed" : "Subtitling of {sourceFile} has failed",
    ...
    "Scheduled task is pending review" : "Scheduled task is pending review",
    "\"%s\" awaits your review before continuing." : "\"%s\" awaits your review before continuing.",
    "View scheduled task" : "View scheduled task",
    "Scheduled task succeeded" : "Scheduled task succeeded",
    "\"%s\" was run successfully." : "\"%s\" was run successfully.",
    "View result" : "View result",
    "Scheduled task failed" : "Scheduled task failed",
    "\"%s\" failed to run." : "\"%s\" failed to run.",
    "AI sticker generation" : "AI sticker generation",
    "An error occurred while scheduling this assignment run. Reach out to your system administrator if this issue persists." : "An error occurred while scheduling this assignment run. Reach out to your system administrator if this issue persists.",
    "Nextcloud Deck" : "Nextcloud Deck",
    "Nextcloud Teams" : "Nextcloud Teams",
    "Nextcloud Tasks" : "Nextcloud Tasks",
    "Complete calendar task" : "Complete calendar task",
    "Nextcloud Talk" : "Nextcloud Talk",
    "Nextcloud Files" : "Nextcloud Files",
    "OpenProject" : "OpenProject",
    "Delete calendar task" : "Delete calendar task",
    "DuckDuckGo web search" : "DuckDuckGo web search",
    "Nextcloud user profile" : "Nextcloud user profile",
    "Nextcloud Calendar" : "Nextcloud Calendar",
    "Nextcloud Contacts" : "Nextcloud Contacts",
    "Nextcloud User Search" : "Nextcloud User Search",
    "Assistant document generation" : "Assistant document generation",
    "Assistant image generation" : "Assistant image generation",
    "OpenStreetMap" : "OpenStreetMap",
    "Norwegian Meteorological Institute weather forecast" : "Norwegian Meteorological Institute weather forecast",
    "Get file content by link" : "Get file content by link",
    "Get form details" : "Get form details",
    "Get form responses" : "Get form responses",
    "HERE Public transport API" : "HERE Public transport API",
    "Get share info" : "Get share info",
    "List bookmark folders" : "List bookmark folders",
    "List bookmark tags" : "List bookmark tags",
    "List bookmarks" : "List bookmarks",
    "List forms" : "List forms",
    "List shares" : "List shares",
    "List calendar tasks" : "List calendar tasks",
    ...
    "Update calendar task" : "Update calendar task",
    ...
    "Work with audio" : "Work with audio",
    ...
    "The new message is too long" : "The new message is too long",
    ...
    "The model used to translate" : "The model used to translate",
    ...
    "cartoon, neutral background, sticker of %1$s" : "cartoon, neutral background, sticker of %1$s",
    "Generate sticker" : "Generate sticker",
    "Generate sticker from text" : "Generate sticker from text",
    "Prompt" : "Prompt",
    "Describe the sticker you would like to create" : "Describe the sticker you would like to create",
    "Output stickers" : "Output stickers",
    "The generated sticker" : "The generated sticker",
    ...
    "Select global skills folder" : "Select global skills folder",
    "Select" : "Select",
    "No folder selected" : "No folder selected",
    "Global skills folder updated" : "Global skills folder updated",
    "Failed to set global skills folder" : "Failed to set global skills folder",
    ...
    "The sticker generation feature won`t work without being able to generate images. Please install and enable a \"Generate image\" provider or disable the \"Generate sticker\" task type." : "The sticker generation feature won`t work without being able to generate images. Please install and enable a \"Generate image\" provider or disable the \"Generate sticker\" task type.",
    "Select which features you want to enable" : "Select which features you want to enable",
    "Nextcloud Assistant in header" : "Nextcloud Assistant in header",
    "AI text generation in the smart picker" : "AI text generation in the smart picker",
    "Text-to-image in the smart picker" : "Text-to-image in the smart picker",
    "Text-to-sticker in the smart picker" : "Text-to-sticker in the smart picker",
    "Speech-to-text in the smart picker" : "Speech-to-text in the smart picker",
    "To be able to use the Assistant, please install at least one AI task processing provider." : "To be able to use the Assistant, please install at least one AI task processing provider.",
    "To enable text generation in the smart picker, please install an AI task processing provider for the \"Free text to text prompt\" task type:" : "To enable text generation in the smart picker, please install an AI task processing provider for the \"Free text to text prompt\" task type:",
    "To enable the sticker generation picker or the image generation picker, please install and enable a \"Generate image\" provider:" : "To enable the sticker generation picker or the image generation picker, please install and enable a \"Generate image\" provider:",
    "To enable speech-to-text in the smart picker, please install and enable a \"Transcribe audio\" provider:" : "To enable speech-to-text in the smart picker, please install and enable a \"Transcribe audio\" provider:",
    "Data folder" : "Data folder",
    "Name of the folder the assistant creates in the files of each user to store generated content. Users can override this in their personal settings. Changing it does not rename folders that already exist." : "Name of the folder the assistant creates in the files of each user to store generated content. Users can override this in their personal settings. Changing it does not rename folders that already exist.",
    "Default data folder name" : "Default data folder name",
    ...
    "It is passed on to the LLMs to better generate a chat title" : "It is passed on to the LLMs to better generate a chat title",
    ...
    "Select a folder containing skills (sub-folders, each holding a SKILL.md file). These will be available to all users in addition to their personal skills in \"Chat with AI\". The folder is resolved from the filesystem of the admin who set it." : "Select a folder containing skills (sub-folders, each holding a SKILL.md file). These will be available to all users in addition to their personal skills in \"Chat with AI\". The folder is resolved from the filesystem of the admin who set it.",
    "Clear" : "Clear",
    "Selected folder" : "Selected folder",
    "Set by" : "Set by",
    "No global skills folder configured" : "No global skills folder configured",
    ...
    "Nextcloud Assistant header menu entry" : "Nextcloud Assistant header menu entry",
    ...
    "Information sources & actions" : "Information sources & actions",
    "Reasoning…" : "Reasoning…",
    "Ask assistant, what's the weather today" : "Ask assistant, what's the weather today",
    "What's the weather today?" : "What's the weather today?",
    "Ask assistant, to create a share link for a file" : "Ask assistant, to create a share link for a file",
    "Can you create a share link for me?" : "Can you create a share link for me?",
    "Ask assistant, to create a scheduled task to send me the weather every morning" : "Ask assistant, to create a scheduled task to send me the weather every morning",
    "Create a scheduled task to send me the weather every morning " : "Create a scheduled task to send me the weather every morning ",
    "Ask assistant, which actions it can do for you" : "Ask assistant, which actions it can do for you",
    "Which actions can you do for me?" : "Which actions can you do for me?",
    "Ask assistant for route from Munich to Berlin using public transport" : "Ask assistant for route from Munich to Berlin using public transport",
    "Can you give me a route from Munich to Berlin using public transport?" : "Can you give me a route from Munich to Berlin using public transport?",
    "Ask assistant to transcribe a media file for you" : "Ask assistant to transcribe a media file for you",
    "Transcribe a media file for me" : "Transcribe a media file for me",
    "Ask assistant to schedule an event for a Design meeting whenever you're free tomorrow" : "Ask assistant to schedule an event for a Design meeting whenever you're free tomorrow",
    "Schedule an event for a Design meeting whenever I'm free tomorrow" : "Schedule an event for a Design meeting whenever I'm free tomorrow",
    "Ask assistant to create a deck card in my Project board in the todo stack for creating the presentation" : "Ask assistant to create a deck card in my Project board in the todo stack for creating the presentation",
    "Create a deck card in my Project board in the todo stack for creating the presentation" : "Create a deck card in my Project board in the todo stack for creating the presentation",
    "Ask assistant to generate a slide deck about the features of Nextcloud" : "Ask assistant to generate a slide deck about the features of Nextcloud",
    "Generate a slide deck about the features of Nextcloud" : "Generate a slide deck about the features of Nextcloud",
    "Ask assistant to generate an image of a puppy with a Nextcloud hat" : "Ask assistant to generate an image of a puppy with a Nextcloud hat",
    "Generate an image of a puppy with a Nextcloud hat" : "Generate an image of a puppy with a Nextcloud hat",
    ...
    "Error fetching assignments" : "Error fetching assignments",
    ...
    "This task has not run yet. Results will appear here after the next scheduled run." : "This task has not run yet. Results will appear here after the next scheduled run.",
    "Scheduled tasks run automatically on a recurring schedule. Ask chat to create one for you." : "Scheduled tasks run automatically on a recurring schedule. Ask chat to create one for you.",
    "Create in chat" : "Create in chat",
    ...
    "Messages should not be longer than {maxLength} characters (currently {length})." : "Messages should not be longer than {maxLength} characters (currently {length}).",
    ...
    "Choose" : "Choose",
    "Task position: {position}" : "Task position: {position}",
    ...
    "Generate new image using AI" : "Generate new image using AI",
    "The result image would be placed in the current folder." : "The result image would be placed in the current folder.",
    "The resulting images are generated by AI. Make sure to double-check and adjust." : "The resulting images are generated by AI. Make sure to double-check and adjust.",
    ...
    "AI text generation in smart picker" : "AI text generation in smart picker",
    "AI image generation in smart picker" : "AI image generation in smart picker",
    "AI sticker generation in smart picker" : "AI sticker generation in smart picker",
    "AI transcription in smart picker" : "AI transcription in smart picker",
    ...
    "Where the assistant stores content it generates for you. Leave empty to use the name your administrator has set. Changing it does not move files that are already there." : "Where the assistant stores content it generates for you. Leave empty to use the name your administrator has set. Changing it does not move files that are already there.",
    "Folder name" : "Folder name",
    "Remembered conversations" : "Remembered conversations",
    ...
    "This task is running in the background." : "This task is running in the background.",
    "You can safely close the assistant or browse other tasks." : "You can safely close the assistant or browse other tasks.",
    ...
    "Running" : "Running",
    "Scheduled" : "Scheduled",
    "_{n} image generated_::_{n} images generated_" : ["{n} image generated","{n} images generated"],
    "_{n} image scheduled_::_{n} images scheduled_" : ["{n} image scheduled","{n} images scheduled"],
    ...
    "Click this to open the file" : "Click this to open the file",
    "This output file has been saved in {path}" : "This output file has been saved in {path}",
    ...
    "Drop a file here to upload it" : "Drop a file here to upload it",
    ...
    "Warning: The input text exceeds the maximum length of {limit} characters (currently {length})." : "Warning: The input text exceeds the maximum length of {limit} characters (currently {length}).",
    ...
    "Improve this text" : "Improve this text",
    ...
    "Something went wrong when scheduling the task" : "Something went wrong when scheduling the task",
    ...
    "Monthly" : "Monthly",
    "Yearly" : "Yearly",
    "_Every %n minute_::_Every %n minutes_" : ["Every %n minute","Every %n minutes"],
    ...
    "Summarization AI task submitted." : "Summarization AI task submitted.",
    ...
    "Text-to-Speech AI task submitted." : "Text-to-Speech AI task submitted.",
    ...
    "Transcription AI task submitted." : "Transcription AI task submitted.",
    ...
    "AI subtitles task submitted." : "AI subtitles task submitted.",
    "It can also be checked in the Assistant in the \"Work with audio -> Generate subtitles\" menu." : "It can also be checked in the Assistant in the \"Work with audio -> Generate subtitles\" menu.",
