OC.L10N.register(
    ...
    "\"{user}\" is a placeholder for the user's display name." : "«{user}» é un marcador de posición para o nome para amosar do usuario.",
    ...
    "\"{user}\" is a placeholder for the user's display name here as well." : "«{user}» tamén aquí é un marcador de posición para o nome para amosar do usuario.",
    ...
    "Run in the background and get notified" : "Executar en segundo plano e recibir notificacións",
    "Cancel" : "Cancelar",
