OC.L10N.register(
    ...
    "Schedule a calendar event" : "일정 만들기",
    "Add a calendar task" : "달력 작업 추가",
    "Create a Deck card" : "덱 카드 만들기",
    ...
    "Failed to get chat message" : "채팅 메시지를 불러오지 못함",
    ...
    "Assistant task" : "어시스턴트 작업",
    "AI text generation" : "AI 텍스트 생성",
    "AI image generation" : "AI 이미지 생성",
    "AI audio transcription" : "AI 음성 받아쓰기",
    "AI context writer" : "AI 글 쓰기",
    ...
    "View task" : "작업 보기",
    "File action has finished" : "파일 작업이 완료됨",
    "{sourceFile} has been summarized in {targetFile}" : "{sourceFile}이 {targetFile}로 요약됨",
    "{sourceFile} has been transcribed in {targetFile}" : "{sourceFile}이{targetFile}로 받아쓰기됨",
    "{sourceFile} has been converted to audio in {targetFile}" : "{sourceFile}이 {targetFile} 음성으로 변환됨",
    "{sourceFile} has been processed, {targetFile} was created" : "{sourceFile} 이 처리되어 {targetFile}기 생성됨",
    "File action has failed" : "파일 작업 실패",
    "Summarization of {sourceFile} has failed" : "{sourceFile}요약 실패",
    "Transcription of {sourceFile} has failed" : "{sourceFile} 받아쓰기 실패",
    "The text-to-speech process for {sourceFile} has failed" : "{sourceFile}받아쓰기 실패",
    "The processing of {sourceFile} has failed" : "{sourceFile}처리 실패",
    "New image file has been generated" : "새 이미지 파일이 생성됨",
    "{targetFile} has been generated in {targetDirectory}" : "{targetFile}이 {targetDirectory}에 생성됨",
    "Image file generation has failed" : "이미지 파일 생성 실패",
    "Generation of a new image file in {targetDirectory} has failed" : "{targetDirectory}에 새 이미지 파일 생성 실패",
    "AI sticker generation" : "AI 스티커 생성",
    "Assistant audio transcription" : "음성 받아쓰기 어시스턴트",
    "Assistant document generation" : "문서 생성 어시스턴트",
    "Nextcloud Calendar" : "Nextcloud 달력",
    "Nextcloud Tasks" : "Nextcloud 작업",
    "Nextcloud Contacts" : "Nextcloud 연락처",
    "Nextcloud user profile" : "Nextcloud 사용자 정보",
    "Nextcloud Deck" : "Nextcloud 덱",
    "Nextcloud Files" : "Nextcloud 파일",
    ...
    "Output shown here is generated by AI. Make sure to always double-check." : "이 출력은 AI에 의해 생성되었습니다. 반드시 다시 확인하세요.",
