OC.L10N.register(
    ...
    "To enable this feature, please install an AI text processing provider for the free prompt task type:" : "بۇ ئىقتىدارنى قوزغىتىش ئۈچۈن ، ھەقسىز تېز ۋەزىپە تۈرىگە AI تېكىست بىر تەرەپ قىلغۇچ تەمىنلىگۈچىنى قاچىلاڭ:",
    ...
    "The text must be shorter than or equal to {maxLength} characters, currently {length}" : "بۇ تېكىست چوقۇم {maxLength} ھەرپتىن قىسقا ياكى تەڭ بولۇشى كېرەك ، ھازىر {ئۇزۇنلۇقى}",
    ...
    "AI provider apps can be found in the {toolLink} and {integrationLink} app settings sections." : "سۈنئىي ئەقىل بىلەن تەمىنلىگۈچىلەر ئەپلىرىنى {toolLink} ۋە {integralLink} ئەپ تەڭشەكلىرى بۆلىكىدىن تاپقىلى بولىدۇ.",
    ...
    "{providerName} for {taskName}" : "{taskName} ئۈچۈن تەمىنلىگۈچى Name",
    ...
    "Your task with ID {id} has failed" : "ID {id with بىلەن بولغان ۋەزىپىڭىز مەغلۇپ بولدى",
