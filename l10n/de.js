OC.L10N.register(
    ...
    "Failed to store the skill" : "Der Skill konnte nicht gespeichert werden",
    ...
    "Select a folder containing skills (sub-folders, each holding a SKILL.md file). These will be available to all users in addition to their personal skills in \"Chat with AI\". The folder is resolved from the filesystem of the admin who set it." : "Einen Ordner mit Fähigkeiten (Unterordner festlegen, die jeweils eine SKILL.md-Datei enthalten). Diese stehen allen Benutzern zusätzlich zu ihren persönlichen Fähigkeiten in „Chat mit KI“ zur Verfügung. Der Ordner wird aus dem Dateisystem des Administrators aufgelöst, der ihn festgelegt hat.",
    "Clear" : "Leeren",
