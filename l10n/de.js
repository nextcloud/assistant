OC.L10N.register(
    "assistant",
    {
    "Summarize using AI" : "Mit KI zusammenfassen",
    "Transcribe audio using AI" : "Audio mittels KI transkribieren",
    "Generate subtitles using AI" : "Untertitel mithilfe von KI erstellen",
    "Text-To-Speech using AI" : "Text-zu-Sprache mittels KI",
    ...
    "Failed to load the skill" : "Fähigkeit konnte nicht geladen werden",
    "Description is too long (max %d characters)" : "Die Beschreibung ist zu lang (maximal %d Zeichen)",
    "Content is too long (max %d characters)" : "Der Inhalt ist zu lang (maximal %d Zeichen)",
    "Failed to store the skill" : "Fähigkeit konnte nicht gespeichert werden",
    ...
    "Assistant task submitted" : "Assistentenaufgabe übermittelt",
    "Transcription task submitted" : "Transkriptionsaufgabe übermittelt",
    "Subtitles task submitted" : "Untertitelaufgabe übermittelt",
    "Summarization task submitted" : "Zusammenfassungsaufgabe übermittelt",
    "Text-to-speech task submitted" : "Text-zu-Sprache-Aufgabe übermittelt",
    ...
    "Create bookmark folder" : "Lesezeichenordner erstellen",
    "Create team" : "Team erstellen",
    "Add member to team" : "Mitglied zu dem Team hinzufügen",
    "Remove member from team" : "Mitglied aus dem Team entfernen",
    "Update team" : "Team aktualisieren",
    "Delete team" : "Team löschen",
    "Share with team" : "Mit Team teilen",
    "Create form" : "Formular erstellen",
    "Add question to form" : "Dem Formular eine Frage hinzufügen",
    "Delete form" : "Formular löschen",
    "Update form settings" : "Formulareinstellungen aktualisieren",
    "Share with user" : "Mit Benutzer teilen",
    "Share with group" : "Mit Gruppe teilen",
    "Update share permissions" : "Freigabeberechtigungen aktualisieren",
    ...
    "Could not find session" : "Sitzung konnte nicht gefunden werden",
    ...
    "Failed to get chat message" : "Chatnachricht konnte nicht abgerufen werden",
    "Failed to delete a chat message" : "Eine Chatnachricht konnte nicht gelöscht werden",
    "Failed to schedule message generation" : "Nachrichtenerstellung konnte nicht geplant werden",
    ...
    "AI subtitles generation" : "Erstellung von Untertiteln mittels KI",
    ...
    "File action has finished" : "Dateiaktion wurde beendet",
    ...
    "{sourceFile} has been subtitled in {targetFile}" : "{sourceFile} wurde in {targetFile} untertitelt",
    ...
    "Subtitling of {sourceFile} has failed" : "Untertitelung von {sourceFile} ist fehlgeschlagen",
    "The text-to-speech process for {sourceFile} has failed" : "Der Text-zu-Sprache-Vorgang für {sourceFile} ist fehlgeschlagen",
    "The processing of {sourceFile} has failed" : "Die Verarbeitung von {sourceFile} ist fehlgeschlagen",
    "New image file has been generated" : "Neue Bilddatei wurde erstellt",
    ...
    "Complete calendar task" : "Kalenderaufgabe fertigstellen",
    "Nextcloud Talk" : "Nextcloud Talk",
    "Nextcloud Files" : "Nextcloud Dateien",
    "OpenProject" : "OpenProject",
    "Delete calendar task" : "Kalenderaufgabe löschen",
    ...
    "Nextcloud User Search" : "Nextcloud-Benutzersuche",
    ...
    "Get file content by link" : "Dateiinhalt via Link abrufen",
    "Get form details" : "Formulardetails abrufen",
    "Get form responses" : "Formularantworten abrufen",
    "HERE Public transport API" : "HERE-API für öffentliche Verkehrsmittel",
    "Get share info" : "Freigabeinfos abrufen",
    "List bookmark folders" : "Lesezeichenordner auflisten",
    "List bookmark tags" : "Lesezeichenschlagworte abrufen",
    "List bookmarks" : "Lesezeichen auflisten",
    "List forms" : "Formulare auflisten",
    "List shares" : "Freigaben auflisten",
    "List calendar tasks" : "Kalenderaufgaben auflisten",
    "List user groups" : "Benutzergruppen auflisten",
    "Search bookmarks" : "Lesezeichen suchen",
    "Nextcloud Mail" : "Nextcloud Mail",
    "Assistant audio transcription" : "Assistent für Audiotranskription",
    "Update calendar task" : "Kalenderaufgabe aktualisieren",
    ...
    "Work with audio" : "Mit Audio arbeiten",
    "Work with text" : "Mit Text arbeiten",
    ...
    "The new message is too long" : "Die neue Nachricht ist zu lang",
    "Message content is empty" : "Nachrichteninhalt ist leer",
    "Failed to encode attachments" : "Anhänge konnten nicht kodiert werden",
    "Message not found" : "Nachricht nicht gefunden",
    "No user message found in this session" : "In dieser Sitzung wurde keine Benutzernachricht gefunden",
    "No human message found in this session" : "In dieser Sitzung wurde keine menschliche Nachricht gefunden",
    "Assistant" : "Assistent",
    ...
    "Select global skills folder" : "Globalen Fähigkeiten-Ordner auswählen",
    "Select" : "Auswählen",
    "No folder selected" : "Kein Ordner ausgewählt",
    "Global skills folder updated" : "Globalen Fähigkeiten-Ordner aktualisiert",
    "Failed to set global skills folder" : "Fehler beim Festlegen des globalen Fähigkeiten-Ordners",
    ...
    "The sticker generation feature won`t work without being able to generate images. Please install and enable a \"Generate image\" provider or disable the \"Generate sticker\" task type." : "Die Stickererstellung funktioniert nicht, ohne dass Bilder erstellt werden können. Bitte einen \"Bilderstellungs-Anbieter\" installieren und aktivieren oder Aufgabentyp „Stickererstellung“ deaktivieren.",
    "Select which features you want to enable" : "Wähle aus, welche Funktionen aktiviert werden sollen",
    "Nextcloud Assistant in header" : "Nextcloud Assistant im Header",
    "AI text generation in the smart picker" : "KI-Texterstellungs-im Smart Picker",
    "Text-to-image in the smart picker" : "Text-zu-Bild im Smart Picker",
    "Text-to-sticker in the smart picker" : "Text-zu-Sticker im Smart Picker",
    "Speech-to-text in the smart picker" : "Sprache-zu-Text im Smart Picker",
    "To be able to use the Assistant, please install at least one AI task processing provider." : "Um den Assistenten nutzen zu können, bitte mindestens einen KI-Aufgabenverarbeitungsanbieter installieren.",
    "To enable text generation in the smart picker, please install an AI task processing provider for the \"Free text to text prompt\" task type:" : "Um die Textgenerierung im Smart Picker zu aktivieren, bitte einen KI-Verarbeitungsanbieter für den Aufgabentyp \"Freitext-zu-Text-Prompt\" installieren:",
    "To enable the sticker generation picker or the image generation picker, please install and enable a \"Generate image\" provider:" : "Um den Stickererstellungs-Picker oder den Bilderzeugungs-Picker zu aktivieren, bitte einen Anbieter für \"Bild generieren\" installieren und aktivieren:",
    "To enable speech-to-text in the smart picker, please install and enable a \"Transcribe audio\" provider:" : "Um Sprache-zu-Text im Smart Picker zu aktivieren, bitte einen „Audio-Transkriptionsanbieter\" installieren und aktivieren:",
    "Data folder" : "Datenordner",
    "Name of the folder the assistant creates in the files of each user to store generated content. Users can override this in their personal settings. Changing it does not rename folders that already exist." : "Name des Ordners, den der Assistent in den Dateien jedes Benutzers erstellt, um generierte Inhalte zu speichern. Benutzer können dies in ihren persönlichen Einstellungen überschreiben. Eine Änderung dieses Namens hat keine Auswirkungen auf bereits vorhandene Ordner.",
    "Default data folder name" : "Standarddatenordnername",
    ...
    "It is passed on to the LLMs to better generate a chat title" : "Es wird an die LLMs weitergegeben, um einen Chat-Titel besser erstellen zu können",
    ...
    "Global Agent Skills" : "Globale Agentenfähigkeiten",
    "Select a folder containing skills (sub-folders, each holding a SKILL.md file). These will be available to all users in addition to their personal skills in \"Chat with AI\". The folder is resolved from the filesystem of the admin who set it." : "Einen Ordner mit Fähigkeiten (Unterordner, die jeweils eine SKILL.md-Datei enthalten) festlegen. Diese stehen allen Benutzern zusätzlich zu ihren persönlichen Fähigkeiten in „Chat mit KI“ zur Verfügung. Der Ordner wird aus dem Dateisystem des Administrators aufgelöst, der ihn festgelegt hat.",
    "Clear" : "Leeren",
    "Selected folder" : "Ausgewählter Ordner",
    "Set by" : "Festgelegt von",
    "No global skills folder configured" : "Kein globaler Fähigkeiten-Ordner konfiguriert",
    ...
    "Nextcloud Assistant header menu entry" : "Menüeintrag des Nextcloud-Assistenten in der Kopfzeile",
    ...
    "Reasoning…" : "Begründe …",
    "Ask assistant, what's the weather today" : "Den Assistenten fragen, wie das Wetter heute wird",
    ...
    "Output shown here is generated by AI. Make sure to always double-check." : "Die hier gezeigte Ausgabe wurde von KI erstellt. Bitte genau überprüfen.",
    ...
    "Choose" : "Auswählen",
    "Task position: {position}" : "Aufgabenposition: {position}",
    ...
    "Context Chat has not finished indexing all your documents yet, it may not be able to answer your questions, yet." : "Kontext-Chat hat die Indizierung der Dokumente noch nicht abgeschlossen und kann die Fragen möglicherweise noch nicht beantworten.",
    "Selective context" : "Selektiver Kontext",
    "No sources referenced" : "Keine Quellen referenziert",
    "Prompt cannot be empty." : "Der Prompt darf nicht leer sein.",
    "Image generation task has been scheduled." : "Die Aufgabe zur Bilderstellung wurde geplant.",
    "Failed to schedule image generation task." : "Fehler beim Planen der Aufgabe zur Bilderstellung.",
    "Generate new image using AI" : "Ein neues Bild mittels KI erstellen",
    "The result image would be placed in the current folder." : "Das Ergebnisbild wird im aktuellen Ordner abgelegt.",
    "The resulting images are generated by AI. Make sure to double-check and adjust." : "Die resultierenden Bilder werden von KI generiert. Bitte sicherstellen, dass es noch einmal überprüft und angepasst wird.",
    "Generate new image" : "Neues Bild erstellen",
    ...
    "Image generation is not available." : "Bilderstellung ist nicht verfügbar",
    ...
    "Auto-play audio chat responses" : "Automatische Wiedergabe von Audio-Chat-Antworten",
    "AI text generation in smart picker" : "KI-Texterstellung im-Smart Picker",
    "AI image generation in smart picker" : "KI-Bilderstellung im-Smart Picker",
    "AI sticker generation in smart picker" : "KI-Stickerstellung im Smart Picker",
    "AI transcription in smart picker" : "KI-Transkription im Smart Picker",
    ...
    "Where the assistant stores content it generates for you. Leave empty to use the name your administrator has set. Changing it does not move files that are already there." : "Hier speichert der Assistent die für dich generierten Inhalte. Lasse dieses Feld leer, um den von deiner Administration festgelegten Namen zu verwenden. Bereits vorhandene Dateien werden durch eine Änderung dieses Feldes nicht verschoben.",
    "Folder name" : "Ordnername",
    "Remembered conversations" : "Gespeicherte Unterhaltung",
    "The following conversations are remembered by the Assistant Chat and will be taken into account for every new conversation:" : "Folgende Unterhaltungen werden vom Assistant-Chat gespeichert und bei jeder neuen Unterhaltung berücksichtigt:",
    ...
    "Access to the microphone was denied. Please check you allowed this page to access the microphone." : "Der Zugriff auf das Mikrofon wurde verweigert. Bitte überprüfen, ob dieser Seite der Zugriff auf das Mikrofon gestattet ist.",
    "Microphone either not available or disabled in settings. Check you are accessing this page with HTTPS or adjust your browser settings." : "Mikrofon entweder nicht verfügbar oder in den Einstellungen deaktiviert. Bitte überprüfen, ob diese Seite mit HTTPS aufgerufen wurde oder die Browsereinstellungen anpassen.",
    ...
    "Drop files here to upload them" : "Dateien zum Hochladen hier fallen lassen",
    "Select from Nextcloud" : "Aus Nextcloud auswählen",
    ...
    "Drop a file here to upload it" : "Datei zum Hochladen hier fallen lassen",
    ...
    "Warning: The input text exceeds the maximum length of {limit} characters (currently {length})." : "Achtung: Der Eingabetext überschreitet die maximale Länge von {limit} Zeichen (derzeit {length}).",
    ...
    "The current Assistant task could not be found" : "Die aktuelle Assistentenaufgabe konnte nicht gefunden werden.",
    "Assistant error" : "Fehler des Assistenten",
    "Something went wrong when scheduling the task" : "Beim Planen der Aufgabe ist etwas schief gelaufen",
    ...
    "The server failed to process your task with ID {id}" : "Der Server konnte Deine Aufgabe mit der ID {id} nicht verarbeiten",
    "Please inform the server administrators of this issue." : "Bitte die Serveradministration über dieses Problem informieren.",
    "No last task type available, falling back to default" : "Letzter Aufgabentyp nicht verfügbar, Änderung auf Standard",
    ...
    "Summarization AI task submitted." : "Ki-Zusammenfassungsaufgabe übermittelt",
    ...
    "Text-to-Speech AI task submitted." : "Ki-Text-zu-Sprache-Aufgabe übermittelt",
    ...
    "Transcription AI task submitted." : "Ki-Transkriptionsaufgabe übermittelt",
    ...
    "AI subtitles task submitted." : "Ki-Untertitelaufgabe übermittelt",
    "It can also be checked in the Assistant in the \"Work with audio -> Generate subtitles\" menu." : "Dies lässt sich auch im Assistenten im Menü \"Mit Audio arbeiten –> Untertitel erstellen\" überprüfen.",
    "Assistant task submitted successfully" : "Assistentenaufgabe erfolgreich übermittelt",
    "Transcription task submitted successfully" : "Transkriptionsaufgabe erfolgreich übermittelt",
    "Summarization task submitted successfully" : "Zusammenfassungsaufgabe übermittelt",
    "Text-to-speech task submitted successfully" : "Text-zu-Sprache-Aufgabe übermittelt",
