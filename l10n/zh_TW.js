OC.L10N.register(
    ...
    "Failed process prompt; unknown user" : "處理提示失敗；未知的使用者",
    ...
    "The transcription could not be found. It may have been deleted." : "找不到轉錄。其可能已被刪除。",
    "Record Audio" : "錄製音訊",
    ...
    "This transcript does not exist or has been cleaned up" : "轉錄不存在或已被清除",
