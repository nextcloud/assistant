OC.L10N.register(
    ...
    "The server failed to process your task with ID {id}. Please inform the server administrators of this issue." : "伺服器無法處理您 ID 為 {id} 的任務。請通知伺服器管理員此問題。",
    ...
    "Assistant failed to schedule your task. Please try again and inform the server administrators if this issue persists." : "小幫手排程您的任務失敗。請再試一次，如果問題仍然存在，請通知伺服器管理員。"
},
"nplurals=1; plural=0;");
