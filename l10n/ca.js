OC.L10N.register(
    ...
    "Your task has been scheduled" : "La teva tasca s'ha planificat",
    ...
    "Failed to schedule the task" : "No s'ha pogut planificar la tasca",
    ...
    "Failed to run or schedule a task" : "No s'ha pogut executar ni planificar una tasca",
    ...
    "Image generation not found." : "No s'ha trobat la generació d'imatge.",
    ...
    "Image storage" : "Emmagatzematge d'imatge",
    "Image generation idle time (days)" : "Temps d'inactivitat de generació d'imatge (dies)",
    "Days until generated images are deleted if they are not viewed" : "Els dies fins que les imatges generades es suprimeixen si no es veuen",
    " This includes the user instructions and the LLM's messages" : " Això inclou les instruccions d'usuari i els missatges del LLM",
    ...
    "Output" : "Sortida",
    "Copy output text to clipboard" : "Còpia del text de sortida al porta-retalls",
    ...
    "The text generation task was scheduled to run in the background." : "La tasca de generació de text estava planificada per executar-se en segon pla.",
    ...
    "Choose Audio File" : "Tria de Fitxer d'àudio",
    ...
    "Choose audio file in your storage" : "Tria un fitxer d'àudio al vostre emmagatzematge",
    "Choose audio File" : "Tria de Fitxer d'àudio",
    "Audio input" : "Entrada d'àudio",
    "Unknown input" : "Entrada desconeguda",
    "_{n} image has been generated_::_{n} images have been generated_" : ["S'ha generat {n} imatges","S'han generat {n} imatges"],
    "_Generation of {n} image is scheduled_::_Generation of {n} images is scheduled_" : ["La generació de {n} imatge està programada","La generació de {n} imatges està planificada"],
    "This task is scheduled" : "Aquesta tasca està planificada",
    ...
    "Image generation" : "Generació d'imatge",
    "Edit visible images" : "Editeu imatges visibles",
    "Click to toggle generation visibility" : "Feu clic per commutar la visibilitat de generació",
    "Generated image" : "Imatge generada",
    "Estimated generation time left: " : "Temps estimat de generació restant: ",
    "The image(s) will be displayed here once generated." : "Les imatge(s) es mostraran aquí un cop generades.",
    "This image generation was scheduled to run in the background." : "Aquesta generació d'imatges estava planificada per executar-se en segon pla.",
    ...
    "Successfully scheduled transcription" : "Transcripció planificada correctament",
    "Failed to schedule transcription" : "No s'ha pogut planificar la transcripció",
    "Unknown API error" : "Error desconegut de l'API",
    "Schedule Transcription" : "Transcripció planificada",
    "A description of the image you want to generate" : "Una descripció de la imatge que voleu generar",
    "Image generation cancel error" : "Error de cancel·lació de generació d'imatge",
    "Unknown image generation cancel error" : "Error de cancel·lació de generació d'imatge desconegut",
    "Unexpected response from server." : "Resposta inesperada del servidor.",
    "Image generation error" : "Error de generació d'imatge",
    "Unknown image generation error" : "Error de generació d'imatge desconegut",
    "You will be notified when the image generation is ready." : "Se us notificarà quan la generació d'imatge estigui llesta.",
    ...
    "Preview image generation by AI" : "Vista prèvia de la generació d'imatge per AI",
    "Submit image(s) generated by AI" : "Envieu imatge(s) generades per AI",
    "Send" : "Envia",
