OC.L10N.register(
    "assistant",
    {
    "User not logged in" : "Benutzer ist nicht angemeldet",
    ...
    "Failed to get the last message" : "Fehler bei8m Abruf der letzten Nachricht",
    "Failed to delete the last message" : "Letzte Nachricht konnte nicht gelöscht werden",
    "Failed to generate a title for the chat session" : "Erstellen eines Titels für die Chat-Sitzung fehlgeschlagen",
