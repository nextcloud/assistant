OC.L10N.register(
    ...
    "Failed to notify when ready; unknown user" : "Fehler beider Fertigstellungsbenachrichtigung; unbekannter Benutzer",
    "Nextcloud Assistant" : "Nextcloud-Assistent",
    "AI context writer" : "KI zum Kontext Schreiben",
    "Writing style: %1$s; Source material: %2$s" : "Schreibstil: %1$s; Quelle: %2$s",
    ...
    "Could not parse file" : "URL konnte nicht geparst werden",
    "Close" : "Schließen",
    ...
    "Writes text in a given style based on the provided source material" : "Schreibt Text in einem vorgegebenen Stil basierend auf dem bereitgestellten Quellenmaterial",
    ...
    "AI image generation smart picker" : "KI-Bildgenerierungs-Smart Picker",
    "AI transcription smart picker" : "KI Transkription Smart Picker",
