OC.L10N.register(
    ...
    "This app brings a user interface to use the Nextcloud text processing feature.\n\nIt allows users to launch AI tasks, be notified when they finish and see the results.\nThe assistant also appears in others apps like Text to easily process parts of a document.\n\n### How to use it\n\nA new right header menu entry appears. Once clicked, the assistant is displayed and you can select and task type and\nset the input you want to process.\n\nThe task might run immediately or be scheduled depending on the time estimation given by the AI provider.\nOnce a task is scheduled, it will run as a background job. When it is finished, you will receive a notification\nfrom which the results can be displayed.\n\nOther apps can integrate with the assistant. For example, Text will display an inline button besides every paragraph\nto directly select a task type to process this paragraph. Selecting a task this way will open the assistant with the task\nbeing pre-selected and the input text set.\n\n## Features\n\nIn the assistant, the list of available tasks depends on the available providers installed via other apps.\nThis means you have complete freedom over which service/software will actually run your AI tasks.\n\n### Text processing providers\n\nSo far, the [Large language model](https://github.com/nextcloud/llm#readme)\nand the [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai) apps\ninclude text processing providers to:\n* Summarize\n* Extract topics\n* Generate a headline\n* Get an answer from a free prompt\n* Reformulate (OpenAi/LocalAi only)\n* Context writer: Generate text with a specified style. The style can be described or provided via an example text.\n\n### Text to image (Image generation)\n\nKnown providers:\n* [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai)\n* [Text2Image Stable Diffusion](https://apps.nextcloud.com/apps/text2image_stablediffusion)\n\n### Speech to text (Audio transcription)\n\nKnown providers:\n* [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai)\n* [Local Whisper Speech-To-Text](https://apps.nextcloud.com/apps/stt_whisper)" : "Diese App bietet eine Benutzeroberfläche für die Verwendung der Nextcloud-Texterstellungsfunktion.\n\nSie ermöglicht Benutzern, KI-Aufgaben zu starten, nach Abschluss der AUfgabe benachrichtigt zu werden und die Ergebnisse zu ansehen.\nDer Assistent erscheint auch in anderen Apps wie z.B. Text, um Teile eines Dokuments einfach verarbeiten zu können.\n\n### Anleitung\n\nIm rechten Kopfmenü erscheint ein neuer Eintrag. Bei Klick ghierauf wird der Assistent angezeigt. Sie können dort einen Aufgabentyp auswählen und die Eingabe festlegen, die verarbeitet werden soll.\n\nDie Aufgabe kann sofort ausgeführt oder, je nach Zeitabschätzung des KI-Anbieters, geplant werden.\nNach Planung der Aufgabe wird sie als Hintergrundjob ausgeführt. Nach deren Abschluss erhalten Sie eine Benachrichtigung,\naus der heraus die Ergebnisse angezeigt werden können.\n\nAndere Apps können den Assistenten integrieren. Zum Beispiel wird in Text neben jedem Absatz eine Schaltfläche angezeigt,\num direkt einen Aufgabentyp zur Verarbeitung des Absatzes auszuwählen. Wenn Sie auf diese Weise eine Aufgabe wählen, wird der Assistent geöffnet,\nwobei die Aufgabe vorausgewählt und der Eingabetext festgelegt ist.\n\n## Funktionen\n\nIm Assistenten hängt die Liste der verfügbaren Aufgaben von den mittels anderer Apps installierten verfügbaren Anbietern ab.\nDies bedeutet, dass Sie die Wahl haben, welcher Dienst/Software Ihre KI-Aufgaben tatsächlich ausführt.\n\n### Texterstellungsanbieter\n\nBisher bieten die Apps [Large language model](https://github.com/nextcloud/llm#readme)\nund [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai) Texterstellungsanbieter für Folgendes an:\n* Zusammenfassen\n* Themen extrahieren\n* Eine Überschrift generieren\n* Eine Antwort auf eine freie Eingabe erhalten\n* Umformulieren (nur OpenAi/LocalAi)\n* Kontexterstellung: Text in einem bestimmten Stil erstellen. Der Stil kann beschrieben oder anhand eines Beispiels bereitgestellt werden.\n\n### Text zu Bild (Bildgenerierung)\n\nBekannte Anbieter:\n* [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai)\n* [Text2Image Stable Diffusion](https://apps.nextcloud.com/apps/text2image_stablediffusion)\n\n### Sprache zu Text (Audio-Transkription)\n\nBekannte Anbieter:\n* [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai)\n* [Local Whisper Speech-To-Text](https://apps.nextcloud.com/apps/stt_whisper)",
    ...
    "To enable this feature, please install any AI text processing provider." : "Um diese Funktion zu aktivieren, installieren Sie bitte einen KI-Textverarbeitungsanbieter.",
    ...
    "Hide previous tasks" : "Vorherige Aufgaben verbergen",
    ...
    "Unknown input" : "Unbekannter Eingang",
    ...
    "_{n} image has been generated_::_{n} images have been generated_" : ["1 Bild wurde erstellt","{n} Bilder wurden erstellt"],
    ...
    "The image(s) will be displayed here once generated." : "Die Bild(er) werden hier angezeigt, sobald sie erstellt wurden.",
