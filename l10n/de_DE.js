OC.L10N.register(
    ...
    "Failed to load the skill" : "Die Fähigkeit konnte nicht geladen werden",
    ...
    "Failed to store the skill" : "Die Fähigkeit konnte nicht gespeichert werden",
    "Failed to notify when ready; unknown user" : "Fehler bei der Benachrichtigung der Fertigstellung; unbekannter Benutzer",
    "Failed to cancel notification; unknown user" : "Benachrichtigung konnte nicht verworfen werden: Unbekannter Benutzer",
    ...
    "Nextcloud Contacts" : "Nextcloud Kontakte",
    ...
    "AI text generation in the smart picker" : "KI-Textgenerierung im Smart Picker",
    ...
    "Access to the microphone was denied. Please check you allowed this page to access the microphone." : "Der Zugriff auf das Mikrofon wurde verweigert. Bitte überprüfen Sie, ob Sie dieser Seite den Zugriff auf das Mikrofon erlaubt haben.",
    "Microphone either not available or disabled in settings. Check you are accessing this page with HTTPS or adjust your browser settings." : "Das Mikrofon ist entweder nicht verfügbar oder in den Einstellungen deaktiviert. Überprüfen Sie, ob Sie mit HTTPS auf diese Seite zugreifen oder passen Sie Ihre Browsereinstellungen an.",
    ...
    "The server failed to process your task with ID {id}" : "Der Server konnte Ihre Aufgabe mit der ID {id} nicht verarbeiten",
