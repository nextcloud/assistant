OC.L10N.register(
    ...
    "Failed to get chat message" : "Не удалось получить сообщение чата",
    ...
    "{sourceFile} has been converted to audio in {targetFile}" : "{sourceFile} был преобразован в аудио в {targetFile}",
    ...
    "Transcription of {sourceFile} has failed" : "Перевод для {sourceFile} не удался",
    "The text-to-speech process for {sourceFile} has failed" : "Процесс преобразования текста в речь для {sourceFile} не удался",
    "The processing of {sourceFile} has failed" : "Обработка {sourceFile} не удалась",
    ...
    "Translate" : "Перевести",
    "Generate file" : "Сгенерировать файл",
    "Work with images" : "Работа с изображениями",
    "Work with audio" : "Работа с аудио",
    "Work with text" : "Работа с текстом",
    ...
    "Retry response generation" : "Повторить генерацию ответа",
    "Output shown here is generated by AI. Make sure to always double-check." : "Выходные данные, показанные здесь, сгенерированы с помощью искусственного интеллекта. Обязательно всегда перепроверяйте.",
    ...
    "Click this to open the file" : "Нажмите здесь, чтобы открыть файл.",
    "This output file has been saved in {path}" : "Этот выходной файл был сохранен в {path}",
