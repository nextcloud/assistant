OC.L10N.register(
    ...
    "List Talk conversations" : "عرض قائمة بمحادثات Talk",
    "List messages in a Talk conversation" : "عرض قائمة بالرسائل داخل محادثة Talk",
    "Schedule a calendar event" : "جدولة حدث في التقويم",
    "List calendars" : "عرض قائمة التقاويم",
    ...
    "Confirm those actions" : "أكِّد على هذه الإجراءات",
    "Cancel" : "إلغاء",
    ...
    "Retrieving the image generation failed." : "إستعادة عملية توليد الصور فشلت.",
    ...
    "Thinking..." : "تفكير ...",
    "Text generation content" : "محتوى مخرجات عملية توليد النصوص",
    ...
    "Preview" : "مُعاينة",
    "You will be notified when the text generation is ready." : "سوف يتم إشعارك بمجرد انتهاء عملية التوليد النصية.",
    ...
    "Copy the link to this generation to clipboard" : "إنسَخ رابط عملية التوليد إلى الحافظة",
