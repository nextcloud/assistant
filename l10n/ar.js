OC.L10N.register(
    ...
    "This app brings a user interface to use the Nextcloud text processing feature.\n\nIt allows users to launch AI tasks, be notified when they finish and see the results.\nThe assistant also appears in others apps like Text to easily process parts of a document.\n\n### How to use it\n\nA new right header menu entry appears. Once clicked, the assistant is displayed and you can select and task type and\nset the input you want to process.\n\nThe task might run immediately or be scheduled depending on the time estimation given by the AI provider.\nOnce a task is scheduled, it will run as a background job. When it is finished, you will receive a notification\nfrom which the results can be displayed.\n\nOther apps can integrate with the assistant. For example, Text will display an inline button besides every paragraph\nto directly select a task type to process this paragraph. Selecting a task this way will open the assistant with the task\nbeing pre-selected and the input text set.\n\n## Features\n\nIn the assistant, the list of available tasks depends on the available providers installed via other apps.\nThis means you have complete freedom over which service/software will actually run your AI tasks.\n\n### Text processing providers\n\nSo far, the [Large language model](https://github.com/nextcloud/llm#readme)\nand the [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai) apps\ninclude text processing providers to:\n* Summarize\n* Extract topics\n* Generate a headline\n* Get an answer from a free prompt\n* Reformulate (OpenAi/LocalAi only)\n* Context writer: Generate text with a specified style. The style can be described or provided via an example text.\n\n### Text to image (Image generation)\n\nKnown providers:\n* [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai)\n* [Text2Image Stable Diffusion](https://apps.nextcloud.com/apps/text2image_stablediffusion)\n\n### Speech to text (Audio transcription)\n\nKnown providers:\n* [OpenAi/LocalAI integration](https://apps.nextcloud.com/apps/integration_openai)\n* [Local Whisper Speech-To-Text](https://apps.nextcloud.com/apps/stt_whisper)" : "يوفر هذا التطبيق واجهة مستخدم لاستعمال ميزة معالجة النص في نكست كلاود.\n\nفهو يسمح للمستخدمين ببدء مهام الذكاء الاصطناعي، و يقوم بإعلامهم عند الانتهاء منها لرؤية النتائج. \nيظهر المساعد أيضًا في تطبيقات أخرى مثل Text لمعالجة أجزاء من المستند بسهولة. \n\n### كيفية الاستعمال\n \nيظهر مدخل جديد في قائمة الترويسة الجانبية. بمجرد النقر عليه، يتم عرض المساعد ويمكنك تحديد نوع المهمة و تعيين المدخلات الذي تريد معالجتها. \n\nقد يتم تشغيل المهمة على الفور أو قد تتم جدولتها وفقاً لتقدير الوقت الذي يقدمه موفر الذكاء الاصطناعي. بمجرد جدولة المهمة، سيتم تشغيلها كمهمة خلفية. عند الانتهاء، سوف تتلقى إشعاراً يمكن من خلاله استعراض النتائج. \n\nيمكن للتطبيقات الأخرى التكامل مع المساعد. على سبيل المثال، سيعرض تطبيق \"النص\" Text زراً مضمناً بجانب كل فقرة لتحديد نوع المهمة مباشرة لمعالجة هذه الفقرة. سيؤدي تحديد المهمة بهذه الطريقة لفتح المساعد بالمهمة المحددة مسبقا و بمجموعة المدخلات النصية المناسبة. \n\n## الميزات \n\nفي المساعد، تعتمد قائمة المهام المتاحة على مُزوّدي الخدمة المتاحين المثبتين عبر تطبيقات أخرى. هذا يعني أن لديك الحرية الكاملة في تحديد الخدمة/البرنامج الذي سيقوم بالفعل بتشغيل مهام الذكاء الاصطناعي الخاصة بك. \n\n### مزودي معالجة النصوص \n\nحتى الآن، تُوفِّر تطبيقات [النموذج اللغوي الوسيع] (https://github.com/nextcloud/llm#readme) و [تكامل OpenAi/LocalAI] (https://apps.nextcloud.com/apps/integration_openai) مُزودي معالجات النصوص التالية: \n* تلخيص \n* استخلاص المواضيع \n* إنشاء العناوين \n* الحصول على إجابات من مستقبل طلبات مجاني \n* إعادة صياغة النصوص (في حالة OpenAi/LocalAi فقط) \n* الكتابة بحسب السياق: حيث يمكن إنشاء نص بنمط محدد. يمكن وصف النمط أو تقديمه عبر مثال نصي. \n\n### تحويل النص إلى صورة (توليد الصور) \nمقدمي الخدمة المعروفين: \n* [تكامل OpenAi/LocalAI] (https://apps.nextcloud.com/apps/integration_openai) \n* [الانتشار المستقر لـ Text2Image] (https://apps.nextcloud.com/apps/text2image_stablediffusion) \n\n### تحويل الكلام إلى نص (الاستنساخ الصوتي) \nمقدمي الخدمة المعروفين: \n* [تكامل OpenAi/LocalAI] (https://apps.nextcloud.com/apps/integration_openai) \n* [الهامس المحلي لتحويل الكلام إلى نص] (https://apps.nextcloud.com/apps/stt_whisper)",
