OC.L10N.register(
    ...
    "Enable Nextcloud Assistant in header" : "Activer l'Assistant Nextcloud dans l'entête",
    ...
    "Enable AI text generation in smart picker" : "Activer la génération de texte par IA dans le sélecteur intelligent",
    "To enable this feature, please install an AI task processing provider for the free prompt task type:" : "Pour activer cette fonctionnalité, veuillez installer un fournisseur de traitement de tâche IA de type saisie libre :",
    "Enable text-to-image in smart picker" : "Activer la génération d'image à partir du texte dans le sélecteur intelligent",
    "Enable text-to-sticker in smart picker" : "Activer le text-to-sticker dans le sélecteur intelligent",
    "To enable this feature, please install a text-to-image provider:" : "Pour activer cette fonctionnalité, veuillez installer un fournisseur de conversion de texte en image :",
    "Enable speech-to-text in smart picker" : "Activer la génération de texte à partir de l'audio dans le sélecteur intelligent",
    ...
    "Enable AI image generation in smart picker" : "Activer le générateur d'image par IA dans le sélecteur intelligent",
    "Enable AI sticker generation in smart picker" : "Activer la génération d'emoji depuis du texte par IA dans le sélecteur intelligent",
    "Enable AI transcription in smart picker" : "Activer la transcription par IA dans le sélecteur intelligent",
