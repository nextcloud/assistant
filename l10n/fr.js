OC.L10N.register(
    ...
    "Failed to get chat message" : "Échec de récupération du message instantané",
    ...
    "Input transcript" : "Transcription",
    "Transcription of the audio input" : "Transcription de l'audio",
    ...
    "AI provider apps can be found in the {toolLink} and {integrationLink} app settings sections." : "Les applications des fournisseurs d'IA peuvent être trouvé dans les paramètres des applications {toolLink} et {integrationLink}.",
    ...
    "Enable AI transcription in smart picker" : "Activer la retranscription audio par IA dans le sélecteur intelligent",
    ...
    "Other" : "Autre",
    "Access to the microphone was denied. Please check you allowed this page to access the microphone." : "L'accès au micro a été refusé. Veuillez vérifier que vous avez autorisé cette page à accéder au microphone.",
    "Microphone either not available or disabled in settings. Check you are accessing this page with HTTPS or adjust your browser settings." : "Le microphone n'est pas disponible ou désactivé dans les paramètres. Vérifiez que vous accédez à cette page via HTTPS ou modifiez les paramètres de votre navigateur.",
    ...
    "You will be notified when it is ready." : "Vous serez averti lorsque lce sera prêt.",
    ...
    "It can also be checked in the Assistant in the \"Work with audio -> Generate speech\" menu." : "Vous pouvez également vérifier cela dans l'Assistant, dans le menu \"Travailler avec l'audio > Générer de la parole\".",
